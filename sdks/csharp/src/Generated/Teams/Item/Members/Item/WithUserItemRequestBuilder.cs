...
using TeamBattles.Sdk.Teams.Item.Members.Item.Role;
namespace TeamBattles.Sdk.Teams.Item.Members.Item
{
    /// <summary>
    ...
    public partial class WithUserItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::TeamBattles.Sdk.Teams.Item.Members.Item.Role.RoleRequestBuilder Role
        {
            get => new global::TeamBattles.Sdk.Teams.Item.Members.Item.Role.RoleRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Teams.Item.Members.Item.WithUserItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUserItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{identifier}/members/{userId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Teams.Item.Members.Item.WithUserItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUserItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{identifier}/members/{userId}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::TeamBattles.Sdk.Models.RemoveTeamMemberResponse"/></returns>
...
#nullable enable
        public async Task<global::TeamBattles.Sdk.Models.RemoveTeamMemberResponse?> DeleteAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::TeamBattles.Sdk.Models.RemoveTeamMemberResponse> DeleteAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::TeamBattles.Sdk.Models.RemoveTeamMemberResponse>(requestInfo, global::TeamBattles.Sdk.Models.RemoveTeamMemberResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Removes a member from a team, or removes yourself to leave it. To remove another member, the caller (key owner) must be the team captain or co-captain; any member may remove themselves. The team captain cannot be removed this way - disband the team or transfer captaincy first. Requires teams.roster:read-write.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::TeamBattles.Sdk.Teams.Item.Members.Item.WithUserItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::TeamBattles.Sdk.Teams.Item.Members.Item.WithUserItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
