...
namespace TeamBattles.Sdk.Tournaments.Item.FreeAgents.Item.Remove
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Tournaments.Item.FreeAgents.Item.Remove.RemoveRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tournaments/{identifier}/free-agents/{freeAgentId}/remove", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Tournaments.Item.FreeAgents.Item.Remove.RemoveRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tournaments/{identifier}/free-agents/{freeAgentId}/remove", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::TeamBattles.Sdk.Tournaments.Item.FreeAgents.Item.Remove.RemoveRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::TeamBattles.Sdk.Tournaments.Item.FreeAgents.Item.Remove.RemoveRequestBuilder WithUrl(string rawUrl)
        {
            return new global::TeamBattles.Sdk.Tournaments.Item.FreeAgents.Item.Remove.RemoveRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
