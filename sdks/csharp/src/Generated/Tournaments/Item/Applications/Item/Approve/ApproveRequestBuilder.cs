...
namespace TeamBattles.Sdk.Tournaments.Item.Applications.Item.Approve
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Tournaments.Item.Applications.Item.Approve.ApproveRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ApproveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tournaments/{identifier}/applications/{participantId}/approve", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Tournaments.Item.Applications.Item.Approve.ApproveRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ApproveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tournaments/{identifier}/applications/{participantId}/approve", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::TeamBattles.Sdk.Tournaments.Item.Applications.Item.Approve.ApproveRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::TeamBattles.Sdk.Tournaments.Item.Applications.Item.Approve.ApproveRequestBuilder WithUrl(string rawUrl)
        {
            return new global::TeamBattles.Sdk.Tournaments.Item.Applications.Item.Approve.ApproveRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
