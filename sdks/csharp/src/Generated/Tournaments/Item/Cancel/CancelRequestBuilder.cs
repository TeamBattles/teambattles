...
namespace TeamBattles.Sdk.Tournaments.Item.Cancel
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Tournaments.Item.Cancel.CancelRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CancelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tournaments/{identifier}/cancel", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Tournaments.Item.Cancel.CancelRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CancelRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tournaments/{identifier}/cancel", rawUrl)
        {
        }
        /// <summary>
        ...
        /// <param name="body">Tournament cancellation payload.</param>
...
#nullable enable
        public async Task<global::TeamBattles.Sdk.Models.TournamentCancelResponse?> PostAsync(global::TeamBattles.Sdk.Models.TournamentCancelRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::TeamBattles.Sdk.Models.TournamentCancelResponse> PostAsync(global::TeamBattles.Sdk.Models.TournamentCancelRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::TeamBattles.Sdk.Models.TournamentCancelResponse>(requestInfo, global::TeamBattles.Sdk.Models.TournamentCancelResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Cancels a tournament. IRREVERSIBLE - there is no un-cancel, and a COMPLETED or already CANCELLED tournament answers 400. Cancelling delists the tournament, emits a `tournament.cancelled` webhook, system-cancels every non-terminal generated match with no forfeit penalty, and notifies the captains of every approved participant. It does NOT change the approval status, so the response reports lifecycle status and approval status as independent fields. Requires an API key holding the tournaments lifecycle capability whose owner is a tournament ADMIN - a tournamentStaff MODERATOR is NOT sufficient and receives 403.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::TeamBattles.Sdk.Models.TournamentCancelRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::TeamBattles.Sdk.Models.TournamentCancelRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::TeamBattles.Sdk.Tournaments.Item.Cancel.CancelRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::TeamBattles.Sdk.Tournaments.Item.Cancel.CancelRequestBuilder WithUrl(string rawUrl)
        {
            return new global::TeamBattles.Sdk.Tournaments.Item.Cancel.CancelRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
