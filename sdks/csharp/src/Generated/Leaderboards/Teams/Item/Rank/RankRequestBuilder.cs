...
namespace TeamBattles.Sdk.Leaderboards.Teams.Item.Rank
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Leaderboards.Teams.Item.Rank.RankRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RankRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/leaderboards/teams/{identifier}/rank{?gameSlug*,sortBy*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Leaderboards.Teams.Item.Rank.RankRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RankRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/leaderboards/teams/{identifier}/rank{?gameSlug*,sortBy*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::TeamBattles.Sdk.Models.LeaderboardRankResponse?> GetAsync(Action<RequestConfiguration<global::TeamBattles.Sdk.Leaderboards.Teams.Item.Rank.RankRequestBuilder.RankRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::TeamBattles.Sdk.Models.LeaderboardRankResponse> GetAsync(Action<RequestConfiguration<global::TeamBattles.Sdk.Leaderboards.Teams.Item.Rank.RankRequestBuilder.RankRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::TeamBattles.Sdk.Leaderboards.Teams.Item.Rank.RankRequestBuilder.RankRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::TeamBattles.Sdk.Leaderboards.Teams.Item.Rank.RankRequestBuilder.RankRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::TeamBattles.Sdk.Leaderboards.Teams.Item.Rank.RankRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::TeamBattles.Sdk.Leaderboards.Teams.Item.Rank.RankRequestBuilder WithUrl(string rawUrl)
        {
            return new global::TeamBattles.Sdk.Leaderboards.Teams.Item.Rank.RankRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Resolves a single team by slug or ID and returns its 1-indexed rank on the public team leaderboard. `sortBy` selects the ranking field: wins (default), winRate, or experience. Pass `gameSlug` to rank within one game&apos;s leaderboard; omit it for the global (all-games) board. An unknown `gameSlug` returns 404. `rank` is null when the team is excluded from the leaderboard (private or disabled) and also when the team ranks beyond the internal scan window, since the rank is a bounded best-effort computation rather than a full-table sort. A missing or inactive team returns 404; an active but excluded team returns 200 with rank null. Requires teams.profile:read.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RankRequestBuilderGetRequestConfiguration : RequestConfiguration<global::TeamBattles.Sdk.Leaderboards.Teams.Item.Rank.RankRequestBuilder.RankRequestBuilderGetQueryParameters>
        {
        }
    }
}
