...
namespace TeamBattles.Sdk.Leaderboards.Players.Me.Rank
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Leaderboards.Players.Me.Rank.RankRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RankRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/leaderboards/players/me/rank{?sortBy*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Leaderboards.Players.Me.Rank.RankRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RankRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/leaderboards/players/me/rank{?sortBy*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::TeamBattles.Sdk.Models.LeaderboardRankResponse?> GetAsync(Action<RequestConfiguration<global::TeamBattles.Sdk.Leaderboards.Players.Me.Rank.RankRequestBuilder.RankRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::TeamBattles.Sdk.Models.LeaderboardRankResponse> GetAsync(Action<RequestConfiguration<global::TeamBattles.Sdk.Leaderboards.Players.Me.Rank.RankRequestBuilder.RankRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::TeamBattles.Sdk.Leaderboards.Players.Me.Rank.RankRequestBuilder.RankRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::TeamBattles.Sdk.Leaderboards.Players.Me.Rank.RankRequestBuilder.RankRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::TeamBattles.Sdk.Leaderboards.Players.Me.Rank.RankRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::TeamBattles.Sdk.Leaderboards.Players.Me.Rank.RankRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RankRequestBuilderGetRequestConfiguration : RequestConfiguration<global::TeamBattles.Sdk.Leaderboards.Players.Me.Rank.RankRequestBuilder.RankRequestBuilderGetQueryParameters>
        {
        }
    }
}
