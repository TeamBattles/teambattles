...
namespace TeamBattles.Sdk.Leagues.Item.Matches.Item.Status
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Leagues.Item.Matches.Item.Status.StatusRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StatusRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/leagues/{identifier}/matches/{matchId}/status", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Leagues.Item.Matches.Item.Status.StatusRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StatusRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/leagues/{identifier}/matches/{matchId}/status", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::TeamBattles.Sdk.Models.GameStatusUpdateResponse?> PatchAsync(global::TeamBattles.Sdk.Models.LeagueStatusUpdateBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::TeamBattles.Sdk.Models.GameStatusUpdateResponse> PatchAsync(global::TeamBattles.Sdk.Models.LeagueStatusUpdateBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::TeamBattles.Sdk.Models.LeagueStatusUpdateBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::TeamBattles.Sdk.Models.LeagueStatusUpdateBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::TeamBattles.Sdk.Leagues.Item.Matches.Item.Status.StatusRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::TeamBattles.Sdk.Leagues.Item.Matches.Item.Status.StatusRequestBuilder WithUrl(string rawUrl)
        {
            return new global::TeamBattles.Sdk.Leagues.Item.Matches.Item.Status.StatusRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
