...
namespace TeamBattles.Sdk.Leagues.Item.Seasons.Item.Activate
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Leagues.Item.Seasons.Item.Activate.ActivateRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ActivateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/leagues/{identifier}/seasons/{seasonId}/activate", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Leagues.Item.Seasons.Item.Activate.ActivateRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ActivateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/leagues/{identifier}/seasons/{seasonId}/activate", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::TeamBattles.Sdk.Models.ActivateLeagueSeasonResponse"/></returns>
...
#nullable enable
        public async Task<global::TeamBattles.Sdk.Models.ActivateLeagueSeasonResponse?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::TeamBattles.Sdk.Models.ActivateLeagueSeasonResponse> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::TeamBattles.Sdk.Models.ActivateLeagueSeasonResponse>(requestInfo, global::TeamBattles.Sdk.Models.ActivateLeagueSeasonResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Activates an upcoming league season. Requires the league seasons capability. Replays are not deduped; existing state guards return the current state error if the season is no longer upcoming.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::TeamBattles.Sdk.Leagues.Item.Seasons.Item.Activate.ActivateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::TeamBattles.Sdk.Leagues.Item.Seasons.Item.Activate.ActivateRequestBuilder WithUrl(string rawUrl)
        {
            return new global::TeamBattles.Sdk.Leagues.Item.Seasons.Item.Activate.ActivateRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
