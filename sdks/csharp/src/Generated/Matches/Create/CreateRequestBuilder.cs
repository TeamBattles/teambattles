...
namespace TeamBattles.Sdk.Matches.Create
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Matches.Create.CreateRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/matches/create", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::TeamBattles.Sdk.Matches.Create.CreateRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/matches/create", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::TeamBattles.Sdk.Models.CreateMatchResponse"/></returns>
        /// <param name="body">Creates a new match as the API key owner.</param>
...
#nullable enable
        public async Task<global::TeamBattles.Sdk.Models.CreateMatchResponse?> PostAsync(global::TeamBattles.Sdk.Models.CreateMatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::TeamBattles.Sdk.Models.CreateMatchResponse> PostAsync(global::TeamBattles.Sdk.Models.CreateMatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::TeamBattles.Sdk.Models.CreateMatchResponse>(requestInfo, global::TeamBattles.Sdk.Models.CreateMatchResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Creates a new match as the personal API key owner. The owner must captain the creator team and the active roster must be members of that team. League and challenge rules are enforced exactly as in the web app. Requires matches.user_matches:read-write and API writes access. Supports an optional `Idempotency-Key` header for safe retries.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::TeamBattles.Sdk.Models.CreateMatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::TeamBattles.Sdk.Models.CreateMatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::TeamBattles.Sdk.Matches.Create.CreateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::TeamBattles.Sdk.Matches.Create.CreateRequestBuilder WithUrl(string rawUrl)
        {
            return new global::TeamBattles.Sdk.Matches.Create.CreateRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
