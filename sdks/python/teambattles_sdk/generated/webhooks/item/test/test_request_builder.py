...
class TestRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/webhooks/{id}/test", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WebhookTestResult]:
        """
        ...
        Returns: Optional[WebhookTestResult]
        """
        ...
        return await self.request_adapter.send_async(request_info, WebhookTestResult, error_mapping)
