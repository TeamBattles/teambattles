...
class WithUserItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/teams/{identifier}/members/{userId}", path_parameters)
    
    async def delete(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RemoveTeamMemberResponse]:
        """
        ...
        Returns: Optional[RemoveTeamMemberResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, RemoveTeamMemberResponse, error_mapping)
