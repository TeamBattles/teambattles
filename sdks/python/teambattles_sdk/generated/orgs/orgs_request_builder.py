...
if TYPE_CHECKING:
    from ..models.create_org_body import CreateOrgBody
...
class OrgsRequestBuilder(BaseRequestBuilder):
    """
    ...
    async def post(self,body: CreateOrgBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CreateOrgResponse]:
        """
        ...
        Returns: Optional[CreateOrgResponse]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, CreateOrgResponse, error_mapping)
    
    def to_post_request_information(self,body: CreateOrgBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Creates a new organization as the personal API key owner. The owner becomes the organization owner. Role ceilings and cascades are enforced exactly as in the web app. Requires orgs.profile:read-write and API writes access. Supports an optional `Idempotency-Key` header for safe retries.
        param body: Creates a new organization as the API key owner.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> OrgsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: OrgsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return OrgsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class OrgsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
