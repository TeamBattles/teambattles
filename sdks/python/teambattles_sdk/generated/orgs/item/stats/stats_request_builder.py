...
if TYPE_CHECKING:
    ...
    from .stats_get_response import StatsGetResponse
...
class StatsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/orgs/{identifier}/stats", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[StatsGetResponse]:
        """
        ...
        Returns: Optional[StatsGetResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, StatsGetResponse, error_mapping)
    ...
    @dataclass
    class StatsRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
