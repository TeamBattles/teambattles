...
if TYPE_CHECKING:
    from ....models.api_organization_stats import ApiOrganizationStats
...
class StatsGetResponse(Parsable):
    ...
    stats: Optional[ApiOrganizationStats] = None
    # ISO 8601 timestamp.
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "stats": lambda n : setattr(self, 'stats', n.get_object_value(ApiOrganizationStats)),
