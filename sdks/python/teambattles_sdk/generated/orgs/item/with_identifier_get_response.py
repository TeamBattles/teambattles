...
if TYPE_CHECKING:
    from ...models.api_organization_profile import ApiOrganizationProfile

@dataclass
class WithIdentifierGetResponse(Parsable):
    """
    Envelope containing organization plus a response timestamp.
    """
    # API-safe organization profile.
    organization: Optional[ApiOrganizationProfile] = None
    # ISO 8601 timestamp.
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "organization": lambda n : setattr(self, 'organization', n.get_object_value(ApiOrganizationProfile)),
