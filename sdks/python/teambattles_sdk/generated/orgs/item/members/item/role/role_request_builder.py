...
if TYPE_CHECKING:
    ...
    from ......models.set_org_member_role_body import SetOrgMemberRoleBody
    from ......models.set_org_member_role_response import SetOrgMemberRoleResponse
...
class RoleRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/orgs/{identifier}/members/{userId}/role", path_parameters)
    
    async def patch(self,body: SetOrgMemberRoleBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SetOrgMemberRoleResponse]:
        """
        ...
        Returns: Optional[SetOrgMemberRoleResponse]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, SetOrgMemberRoleResponse, error_mapping)
    
    def to_patch_request_information(self,body: SetOrgMemberRoleBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Sets an organization member's role to ADMIN, MANAGER, or MEMBER. The caller (key owner) must be the organization owner. The owner role cannot be assigned or removed this way - use ownership transfer instead. Requires orgs.roster:read-write.
        param body: Set an organization member's role.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
