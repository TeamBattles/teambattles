...
if TYPE_CHECKING:
    from ...models.create_match_request_body import CreateMatchRequestBody
    from ...models.create_match_response import CreateMatchResponse
...
class CreateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/matches/create", path_parameters)
    ...
    async def post(self,body: CreateMatchRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CreateMatchResponse]:
        ...
        return await self.request_adapter.send_async(request_info, CreateMatchResponse, error_mapping)
