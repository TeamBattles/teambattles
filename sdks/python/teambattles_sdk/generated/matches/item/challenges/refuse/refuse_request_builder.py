...
if TYPE_CHECKING:
    ...
    from .....models.refuse_challenge_request_body import RefuseChallengeRequestBody
    from .....models.refuse_challenge_response import RefuseChallengeResponse

class RefuseRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/matches/{matchId}/challenges/refuse", path_parameters)
    ...
    async def post(self,body: RefuseChallengeRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RefuseChallengeResponse]:
        ...
        return await self.request_adapter.send_async(request_info, RefuseChallengeResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> RefuseRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: RefuseRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return RefuseRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class RefuseRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
