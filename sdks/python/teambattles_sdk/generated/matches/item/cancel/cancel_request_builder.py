...
if TYPE_CHECKING:
    from ....models.cancel_match_request_body import CancelMatchRequestBody
...
class CancelRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/matches/{matchId}/cancel", path_parameters)
    ...
    async def post(self,body: CancelMatchRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CancelMatchResponse]:
        ...
        return await self.request_adapter.send_async(request_info, CancelMatchResponse, error_mapping)
