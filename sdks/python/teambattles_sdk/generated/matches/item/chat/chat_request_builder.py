...
if TYPE_CHECKING:
    ...
    from .chat_get_response import ChatGetResponse
...
class ChatRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ChatRequestBuilderGetQueryParameters]] = None) -> Optional[ChatGetResponse]:
        """
        ...
        Returns: Optional[ChatGetResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, ChatGetResponse, error_mapping)
    
    async def post(self,body: SendChatMessageRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SendChatMessageResponse]:
        """
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[SendChatMessageResponse]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, SendChatMessageResponse, error_mapping)
    ...
    def to_post_request_information(self,body: SendChatMessageRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Sends a message to a match's chat room as the API key owner. The owner must be a participant of the match; a non-participant receives 403. Requires the chat.write scope and the writes feature. Supports the Idempotency-Key header.
        param body: Sends a message to the match chat room as the API key owner.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class ChatRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
