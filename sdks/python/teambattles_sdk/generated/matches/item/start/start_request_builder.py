...
if TYPE_CHECKING:
    ...
    from ....models.start_match_response import StartMatchResponse
...
class StartRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/matches/{matchId}/start", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[StartMatchResponse]:
        """
        ...
        Returns: Optional[StartMatchResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, StartMatchResponse, error_mapping)
