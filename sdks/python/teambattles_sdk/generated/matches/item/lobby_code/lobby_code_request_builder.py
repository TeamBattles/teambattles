...
if TYPE_CHECKING:
    ...
    from ....models.update_lobby_code_request_body import UpdateLobbyCodeRequestBody
    from ....models.update_lobby_code_response import UpdateLobbyCodeResponse

class LobbyCodeRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/matches/{matchId}/lobby-code", path_parameters)
    ...
    async def post(self,body: UpdateLobbyCodeRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UpdateLobbyCodeResponse]:
        ...
        return await self.request_adapter.send_async(request_info, UpdateLobbyCodeResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> LobbyCodeRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: LobbyCodeRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return LobbyCodeRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class LobbyCodeRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
