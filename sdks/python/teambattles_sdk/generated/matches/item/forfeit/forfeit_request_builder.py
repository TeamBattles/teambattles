...
if TYPE_CHECKING:
    ...
    from ....models.forfeit_match_request_body import ForfeitMatchRequestBody
    from ....models.forfeit_match_response import ForfeitMatchResponse
...
class ForfeitRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/matches/{matchId}/forfeit", path_parameters)
    ...
    async def post(self,body: ForfeitMatchRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ForfeitMatchResponse]:
        ...
        return await self.request_adapter.send_async(request_info, ForfeitMatchResponse, error_mapping)
