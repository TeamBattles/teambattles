...
if TYPE_CHECKING:
    from ......models.approve_acceptance_request_body import ApproveAcceptanceRequestBody
    from ......models.approve_acceptance_response import ApproveAcceptanceResponse
...
class ApproveRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/matches/{matchId}/acceptances/{acceptanceId}/approve", path_parameters)
    ...
    async def post(self,body: ApproveAcceptanceRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ApproveAcceptanceResponse]:
        ...
        return await self.request_adapter.send_async(request_info, ApproveAcceptanceResponse, error_mapping)
