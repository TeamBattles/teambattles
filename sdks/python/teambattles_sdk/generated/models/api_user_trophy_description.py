...
if TYPE_CHECKING:
    from .api_user_trophy_description_member1 import ApiUserTrophy_descriptionMember1

@dataclass
class ApiUserTrophy_description(ComposedTypeWrapper, Parsable):
    """
    Composed type wrapper for classes ApiUserTrophy_descriptionMember1, str
    """
    # Composed type representation for type ApiUserTrophy_descriptionMember1
    ...
    def create_from_discriminator_value(parse_node: ParseNode) -> ApiUserTrophy_description:
        ...
        Returns: ApiUserTrophy_description
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        result = ApiUserTrophy_description()
