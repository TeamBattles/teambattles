...
@dataclass
class TournamentPrizeBreakdownEntry(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TournamentPrizeBreakdownEntry:
        """
