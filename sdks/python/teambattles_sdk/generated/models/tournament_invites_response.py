...
@dataclass
class TournamentInvitesResponse(Parsable):
    """
    ...
    invites: Optional[list[TournamentInvite]] = None
    # Response generation time (ISO 8601).
    timestamp: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TournamentInvitesResponse:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "invites": lambda n : setattr(self, 'invites', n.get_collection_of_object_values(TournamentInvite)),
