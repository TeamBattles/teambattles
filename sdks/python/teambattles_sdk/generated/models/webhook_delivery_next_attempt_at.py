...
if TYPE_CHECKING:
    from .webhook_delivery_next_attempt_at_member1 import WebhookDelivery_nextAttemptAtMember1

@dataclass
class WebhookDelivery_nextAttemptAt(ComposedTypeWrapper, Parsable):
    """
    ...
    def create_from_discriminator_value(parse_node: ParseNode) -> WebhookDelivery_nextAttemptAt:
        ...
        Returns: WebhookDelivery_nextAttemptAt
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        result = WebhookDelivery_nextAttemptAt()
