...
if TYPE_CHECKING:
    ...
    from .api_user_team_membership_avatar_url import ApiUserTeamMembership_avatarUrl
    from .api_user_team_membership_joined_at import ApiUserTeamMembership_joinedAt
    from .api_user_team_membership_slug import ApiUserTeamMembership_slug
    from .api_user_team_membership_tag import ApiUserTeamMembership_tag
    from .profile_visibility import ProfileVisibility

@dataclass
class ApiUserTeamMembership(Parsable):
    """
    API-safe team affiliation row on a user profile.
    """
    # The avatarUrl property
    avatar_url: Optional[ApiUserTeamMembership_avatarUrl] = None
    # Team ID.
    id: Optional[str] = None
    # The joinedAt property
    joined_at: Optional[ApiUserTeamMembership_joinedAt] = None
    # Team name.
    ...
    # The slug property
    slug: Optional[ApiUserTeamMembership_slug] = None
    # The tag property
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "avatarUrl": lambda n : setattr(self, 'avatar_url', n.get_object_value(ApiUserTeamMembership_avatarUrl)),
            "id": lambda n : setattr(self, 'id', n.get_str_value()),
            "joinedAt": lambda n : setattr(self, 'joined_at', n.get_object_value(ApiUserTeamMembership_joinedAt)),
            ...
            "slug": lambda n : setattr(self, 'slug', n.get_object_value(ApiUserTeamMembership_slug)),
            "tag": lambda n : setattr(self, 'tag', n.get_object_value(ApiUserTeamMembership_tag)),
