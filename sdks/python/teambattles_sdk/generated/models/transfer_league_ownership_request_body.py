...
@dataclass
class TransferLeagueOwnershipRequestBody(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TransferLeagueOwnershipRequestBody:
        """
