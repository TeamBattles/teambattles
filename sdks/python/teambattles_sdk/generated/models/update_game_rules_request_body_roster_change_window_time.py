...
@dataclass
class UpdateGameRulesRequestBody_rosterChangeWindowTime(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UpdateGameRulesRequestBody_rosterChangeWindowTime:
        """
