...
@dataclass
class ApiMatchDetailResponse(Parsable):
    """
    SP-2 match detail response.
    """
    # Participant-gated SP-2 match detail. Lobby codes are intentionally omitted.
    match: Optional[ApiMatchDetail] = None
    # The timestamp property
    timestamp: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ApiMatchDetailResponse:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "match": lambda n : setattr(self, 'match', n.get_object_value(ApiMatchDetail)),
