...
if TYPE_CHECKING:
    from .webhook_endpoint_last_delivered_at_member1 import WebhookEndpoint_lastDeliveredAtMember1

@dataclass
class WebhookEndpoint_lastDeliveredAt(ComposedTypeWrapper, Parsable):
    """
    ...
    def create_from_discriminator_value(parse_node: ParseNode) -> WebhookEndpoint_lastDeliveredAt:
        ...
        Returns: WebhookEndpoint_lastDeliveredAt
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        result = WebhookEndpoint_lastDeliveredAt()
