...
if TYPE_CHECKING:
    from .api_match_team_score_member1 import ApiMatchTeam_scoreMember1

@dataclass
class ApiMatchTeam_score(ComposedTypeWrapper, Parsable):
    """
    Composed type wrapper for classes ApiMatchTeam_scoreMember1, int
    """
    # Composed type representation for type ApiMatchTeam_scoreMember1
    ...
    def create_from_discriminator_value(parse_node: ParseNode) -> ApiMatchTeam_score:
        ...
        Returns: ApiMatchTeam_score
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        result = ApiMatchTeam_score()
