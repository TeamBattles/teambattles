...
@dataclass
class LeagueSeasonOptionsRequestBody(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> LeagueSeasonOptionsRequestBody:
        """
