...
class OrganizationsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{identifier}/organizations", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[OrganizationsGetResponse]:
        """
        ...
        Returns: Optional[OrganizationsGetResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, OrganizationsGetResponse, error_mapping)
    ...
    @dataclass
    class OrganizationsRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
