...
if TYPE_CHECKING:
    ...
    from ......models.revoke_ban_request_body import RevokeBanRequestBody
    from ......models.revoke_ban_response import RevokeBanResponse
...
class RevokeRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/bans/{banId}/revoke", path_parameters)
    ...
    async def post(self,body: RevokeBanRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RevokeBanResponse]:
        ...
        return await self.request_adapter.send_async(request_info, RevokeBanResponse, error_mapping)
