...
class BansRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: BansRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[LeagueBans]:
        ...
        return await self.request_adapter.send_async(request_info, LeagueBans, error_mapping)
    
    def to_post_request_information(self,body: BansRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Returns team bans for a league resolved by slug, with optional status filtering. The API key owner must have a MANAGER+ league role or be TeamBattles staff. Requires the leagues.league_admin:read permission.
        param body: Status filter for league team bans.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> BansRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: BansRequestBuilder
        """
        if raw_url is None:
