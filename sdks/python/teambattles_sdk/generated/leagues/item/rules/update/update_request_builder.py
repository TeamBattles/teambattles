...
if TYPE_CHECKING:
    ...
    from .....models.rule_write_response import RuleWriteResponse
    from .....models.update_game_rules_request_body import UpdateGameRulesRequestBody
...
class UpdateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/rules/update", path_parameters)
    
    async def post(self,body: UpdateGameRulesRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RuleWriteResponse]:
        """
        ...
        Returns: Optional[RuleWriteResponse]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, RuleWriteResponse, error_mapping)
    
    def to_post_request_information(self,body: UpdateGameRulesRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Creates or updates enforced rules for a league game. Requires a personal or developer API key whose owner is currently a league ADMIN of the league in the path, with the league rules capability enabled on the key. League API access is gated at api_pro on the league owner's plan.
        param body: Updates league game rules.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
