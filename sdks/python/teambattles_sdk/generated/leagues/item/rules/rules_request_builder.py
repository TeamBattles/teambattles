...
class RulesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/rules", path_parameters)
    
    async def post(self,body: RulesRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[LeagueRules]:
        """
        ...
        return await self.request_adapter.send_async(request_info, LeagueRules, error_mapping)
    
    def to_post_request_information(self,body: RulesRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Returns the game rules and points configuration for a league + game, resolved by league slug. Requires the leagues.league_public:read permission.
        param body: Game selector for league rules and points config.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
