...
if TYPE_CHECKING:
    ...
    from .....models.league_dashboard_stats_response import LeagueDashboardStatsResponse
...
class StatsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/dashboard/stats", path_parameters)
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[LeagueDashboardStatsResponse]:
        ...
        return await self.request_adapter.send_async(request_info, LeagueDashboardStatsResponse, error_mapping)
    ...
    @dataclass
    class StatsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
