...
if TYPE_CHECKING:
    ...
    from ......models.reply_league_ticket_request_body import ReplyLeagueTicketRequestBody
    from ......models.reply_league_ticket_response import ReplyLeagueTicketResponse
...
class ReplyRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/tickets/{ticketId}/reply", path_parameters)
    ...
    async def post(self,body: ReplyLeagueTicketRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ReplyLeagueTicketResponse]:
        ...
        return await self.request_adapter.send_async(request_info, ReplyLeagueTicketResponse, error_mapping)
