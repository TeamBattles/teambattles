...
if TYPE_CHECKING:
    ...
    from ....models.league_settings_response import LeagueSettingsResponse
    from .enabled.enabled_request_builder import EnabledRequestBuilder
...
class SettingsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/settings", path_parameters)
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[LeagueSettingsResponse]:
        ...
        return await self.request_adapter.send_async(request_info, LeagueSettingsResponse, error_mapping)
    ...
    @property
    def enabled(self) -> EnabledRequestBuilder:
        """
        The enabled property
        """
        from .enabled.enabled_request_builder import EnabledRequestBuilder

        return EnabledRequestBuilder(self.request_adapter, self.path_parameters)
