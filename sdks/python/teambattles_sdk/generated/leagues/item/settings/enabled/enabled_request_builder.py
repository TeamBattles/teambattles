...
if TYPE_CHECKING:
    ...
    from .....models.set_league_enabled_request_body import SetLeagueEnabledRequestBody
    from .....models.set_league_enabled_response import SetLeagueEnabledResponse

class EnabledRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/settings/enabled", path_parameters)
    ...
    async def post(self,body: SetLeagueEnabledRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SetLeagueEnabledResponse]:
        ...
        return await self.request_adapter.send_async(request_info, SetLeagueEnabledResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> EnabledRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: EnabledRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return EnabledRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class EnabledRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
