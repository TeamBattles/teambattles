...
if TYPE_CHECKING:
    ...
    from ......models.game_player_stats_body import GamePlayerStatsBody
    from ......models.game_player_stats_response import GamePlayerStatsResponse

class PlayerStatsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/matches/{matchId}/player-stats", path_parameters)
    ...
    async def post(self,body: GamePlayerStatsBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GamePlayerStatsResponse]:
        ...
        return await self.request_adapter.send_async(request_info, GamePlayerStatsResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> PlayerStatsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: PlayerStatsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return PlayerStatsRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class PlayerStatsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
