...
if TYPE_CHECKING:
    ...
    from ......models.league_status_update_body import LeagueStatusUpdateBody
...
class StatusRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/matches/{matchId}/status", path_parameters)
