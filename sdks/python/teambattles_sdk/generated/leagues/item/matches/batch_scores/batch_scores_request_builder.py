...
if TYPE_CHECKING:
    ...
    from .....models.game_batch_match_scores_body import GameBatchMatchScoresBody
    from .....models.game_batch_match_scores_response import GameBatchMatchScoresResponse

class BatchScoresRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/matches/batch-scores", path_parameters)
    ...
    async def post(self,body: GameBatchMatchScoresBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GameBatchMatchScoresResponse]:
        ...
        return await self.request_adapter.send_async(request_info, GameBatchMatchScoresResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> BatchScoresRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: BatchScoresRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return BatchScoresRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class BatchScoresRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
