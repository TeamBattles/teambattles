...
if TYPE_CHECKING:
    ...
    from ......models.update_league_member_role_request_body import UpdateLeagueMemberRoleRequestBody
    from ......models.update_league_member_role_response import UpdateLeagueMemberRoleResponse
...
class RoleRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/members/{memberId}/role", path_parameters)
    ...
    async def post(self,body: UpdateLeagueMemberRoleRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UpdateLeagueMemberRoleResponse]:
        ...
        return await self.request_adapter.send_async(request_info, UpdateLeagueMemberRoleResponse, error_mapping)
    ...
    @dataclass
    class RoleRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
