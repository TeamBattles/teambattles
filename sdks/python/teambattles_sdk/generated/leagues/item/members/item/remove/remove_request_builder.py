...
if TYPE_CHECKING:
    ...
    from ......models.remove_league_member_response import RemoveLeagueMemberResponse
...
class RemoveRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/members/{memberId}/remove", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RemoveLeagueMemberResponse]:
        """
        ...
        Returns: Optional[RemoveLeagueMemberResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, RemoveLeagueMemberResponse, error_mapping)
