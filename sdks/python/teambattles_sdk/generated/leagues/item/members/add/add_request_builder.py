...
if TYPE_CHECKING:
    from .....models.add_league_member_request_body import AddLeagueMemberRequestBody
    from .....models.add_league_member_response import AddLeagueMemberResponse
...
class AddRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/members/add", path_parameters)
    ...
    async def post(self,body: AddLeagueMemberRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AddLeagueMemberResponse]:
        ...
        return await self.request_adapter.send_async(request_info, AddLeagueMemberResponse, error_mapping)
