...
class PenaltiesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/penalties", path_parameters)
    ...
    async def post(self,body: PenaltiesRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[LeaguePenalties]:
        ...
        return await self.request_adapter.send_async(request_info, LeaguePenalties, error_mapping)
    ...
    def with_url(self,raw_url: str) -> PenaltiesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: PenaltiesRequestBuilder
        """
        if raw_url is None:
