...
if TYPE_CHECKING:
    from .....models.create_penalty_request_body import CreatePenaltyRequestBody
    from .....models.create_penalty_response import CreatePenaltyResponse
...
class CreateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/penalties/create", path_parameters)
    ...
    async def post(self,body: CreatePenaltyRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CreatePenaltyResponse]:
        ...
        return await self.request_adapter.send_async(request_info, CreatePenaltyResponse, error_mapping)
