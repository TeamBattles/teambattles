...
if TYPE_CHECKING:
    from .....models.create_season_request_body import CreateSeasonRequestBody
    from .....models.create_season_response import CreateSeasonResponse
...
class CreateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/seasons/create", path_parameters)
    ...
    async def post(self,body: CreateSeasonRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CreateSeasonResponse]:
        ...
        return await self.request_adapter.send_async(request_info, CreateSeasonResponse, error_mapping)
