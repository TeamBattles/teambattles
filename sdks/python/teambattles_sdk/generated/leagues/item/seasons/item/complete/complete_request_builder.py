...
if TYPE_CHECKING:
    from ......models.complete_league_season_response import CompleteLeagueSeasonResponse
...
class CompleteRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/seasons/{seasonId}/complete", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CompleteLeagueSeasonResponse]:
        """
        ...
        Returns: Optional[CompleteLeagueSeasonResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, CompleteLeagueSeasonResponse, error_mapping)
