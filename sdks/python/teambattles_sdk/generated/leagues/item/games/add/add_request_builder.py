...
if TYPE_CHECKING:
    from .....models.add_league_game_request_body import AddLeagueGameRequestBody
    from .....models.error import Error
    from .....models.league_game_write_response import LeagueGameWriteResponse
...
class AddRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/games/add", path_parameters)
    
    async def post(self,body: AddLeagueGameRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[LeagueGameWriteResponse]:
        """
        ...
        Returns: Optional[LeagueGameWriteResponse]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, LeagueGameWriteResponse, error_mapping)
    
    def to_post_request_information(self,body: AddLeagueGameRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Adds an active game to a league. Requires a personal or developer API key whose owner is currently a league ADMIN of the league in the path, with the league games capability enabled on the key. League API access is gated at api_pro on the league owner's plan.
        param body: Adds a league game.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
