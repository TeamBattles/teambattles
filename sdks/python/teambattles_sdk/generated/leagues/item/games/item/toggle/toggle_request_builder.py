...
if TYPE_CHECKING:
    ...
    from ......models.toggle_league_game_request_body import ToggleLeagueGameRequestBody
    from ......models.toggle_league_game_response import ToggleLeagueGameResponse

class ToggleRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/games/{leagueGameId}/toggle", path_parameters)
    ...
    async def post(self,body: ToggleLeagueGameRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ToggleLeagueGameResponse]:
        ...
        return await self.request_adapter.send_async(request_info, ToggleLeagueGameResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> ToggleRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ToggleRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return ToggleRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class ToggleRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
