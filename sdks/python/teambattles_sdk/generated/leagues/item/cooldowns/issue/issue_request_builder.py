...
if TYPE_CHECKING:
    ...
    from .....models.issue_cooldown_request_body import IssueCooldownRequestBody
    from .....models.issue_cooldown_response import IssueCooldownResponse
...
class IssueRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/cooldowns/issue", path_parameters)
    ...
    async def post(self,body: IssueCooldownRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[IssueCooldownResponse]:
        ...
        return await self.request_adapter.send_async(request_info, IssueCooldownResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> IssueRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: IssueRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return IssueRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class IssueRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
