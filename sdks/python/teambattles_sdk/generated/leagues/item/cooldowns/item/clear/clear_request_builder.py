...
if TYPE_CHECKING:
    from ......models.clear_cooldown_response import ClearCooldownResponse
...
class ClearRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/cooldowns/{cooldownId}/clear", path_parameters)
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ClearCooldownResponse]:
        ...
        return await self.request_adapter.send_async(request_info, ClearCooldownResponse, error_mapping)
