...
if TYPE_CHECKING:
    ...
    from .....models.update_league_branding_request_body import UpdateLeagueBrandingRequestBody
    from .....models.update_league_branding_response import UpdateLeagueBrandingResponse
...
class UpdateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leagues/{identifier}/branding/update", path_parameters)
    ...
    async def post(self,body: UpdateLeagueBrandingRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UpdateLeagueBrandingResponse]:
        ...
        return await self.request_adapter.send_async(request_info, UpdateLeagueBrandingResponse, error_mapping)
