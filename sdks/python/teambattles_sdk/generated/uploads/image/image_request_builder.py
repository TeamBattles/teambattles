...
if TYPE_CHECKING:
    from ...models.bound_image_upload_response import BoundImageUploadResponse
...
class ImageRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/uploads/image", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[BoundImageUploadResponse]:
        """
        ...
        Returns: Optional[BoundImageUploadResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, BoundImageUploadResponse, error_mapping)
    ...
    @dataclass
    class ImageRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
