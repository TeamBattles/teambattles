...
if TYPE_CHECKING:
    ...
    from ....models.tournament_participants_response import TournamentParticipantsResponse
...
class ParticipantsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/tournaments/{identifier}/participants", path_parameters)
    
    def by_participant_id(self,participant_id: str) -> WithParticipantItemRequestBuilder:
        """
        Gets an item from the teambattles_sdk.generated.tournaments.item.participants.item collection
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TournamentParticipantsResponse]:
        """
        ...
        Returns: Optional[TournamentParticipantsResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, TournamentParticipantsResponse, error_mapping)
    ...
    @dataclass
    class ParticipantsRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
