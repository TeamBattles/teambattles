...
if TYPE_CHECKING:
    ...
    from ......models.tournament_remove_participant_body import TournamentRemoveParticipantBody
...
class RemoveRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/tournaments/{identifier}/participants/{participantId}/remove", path_parameters)
    
    async def post(self,body: TournamentRemoveParticipantBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TournamentWriteAck]:
        """
    ...
    def to_post_request_information(self,body: TournamentRemoveParticipantBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Sets the participant to REMOVED, decrementing the participant count if the team was APPROVED. Side effects a client should expect: the team's outbound free-agent offers are expired and the free agents it had picked up are released back to the pool. Unlike disqualification this does NOT propagate through a live bracket. Requires the tournaments registration capability and MANAGER authority on the tournament - a tournament MODERATOR qualifies.
        param body: Participant removal payload.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
