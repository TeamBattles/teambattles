...
if TYPE_CHECKING:
    ...
    from .....models.tournament_open_registration_response import TournamentOpenRegistrationResponse
...
class OpenRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/tournaments/{identifier}/registration/open", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TournamentOpenRegistrationResponse]:
        """
        ...
        Returns: Optional[TournamentOpenRegistrationResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, TournamentOpenRegistrationResponse, error_mapping)
