...
if TYPE_CHECKING:
    ...
    from .....models.tournament_close_registration_response import TournamentCloseRegistrationResponse
...
class CloseRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/tournaments/{identifier}/registration/close", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TournamentCloseRegistrationResponse]:
        """
        ...
        Returns: Optional[TournamentCloseRegistrationResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, TournamentCloseRegistrationResponse, error_mapping)
