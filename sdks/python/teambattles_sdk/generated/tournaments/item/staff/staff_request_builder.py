...
if TYPE_CHECKING:
    ...
    from ....models.tournament_add_staff_body import TournamentAddStaffBody
    from ....models.tournament_staff_response import TournamentStaffResponse
...
class StaffRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/tournaments/{identifier}/staff", path_parameters)
    
    def by_user_id(self,user_id: str) -> WithUserItemRequestBuilder:
        """
        Gets an item from the teambattles_sdk.generated.tournaments.item.staff.item collection
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TournamentStaffResponse]:
        """
        ...
        Returns: Optional[TournamentStaffResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, TournamentStaffResponse, error_mapping)
    
    async def post(self,body: TournamentAddStaffBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TournamentWriteAck]:
        """
    ...
    def to_post_request_information(self,body: TournamentAddStaffBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Grants a user the ADMIN or MODERATOR staff role on the tournament. Requires the tournaments staff capability and ADMIN authority - strictly higher than the MANAGER floor for reading the roster, so a tournament MODERATOR answers 403 and cannot promote themselves. Upserts by user: posting a role for someone who already holds a staff row updates that row instead of creating a second one, so this endpoint is safely retryable and also serves as the change-role operation. A MODERATOR gains the manager-floor endpoints (application review, participant removal and disqualification, free-agent pool moderation) but none of the admin-floor ones.
        param body: Tournament staff addition payload.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> StaffRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: StaffRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return StaffRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class StaffRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class StaffRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
