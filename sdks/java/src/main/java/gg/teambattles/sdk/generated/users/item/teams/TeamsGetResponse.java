package gg.teambattles.sdk.generated.users.item.teams;

import com.microsoft.kiota.serialization.Parsable;
import com.microsoft.kiota.serialization.ParseNode;
import com.microsoft.kiota.serialization.SerializationWriter;
import gg.teambattles.sdk.generated.models.ApiUserTeamMembership;
...
public class TeamsGetResponse implements Parsable {
     ...
     * The teams property
     */
    private java.util.List<ApiUserTeamMembership> teams;
    /**
     * ISO 8601 timestamp.
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("teams", (n) -> { this.setTeams(n.getCollectionOfObjectValues(ApiUserTeamMembership::createFromDiscriminatorValue)); });
        deserializerMap.put("timestamp", (n) -> { this.setTimestamp(n.getStringValue()); });
        return deserializerMap;
    }
    /**
     * Gets the teams property value. The teams property
     * @return a {@link java.util.List<ApiUserTeamMembership>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<ApiUserTeamMembership> getTeams() {
        return this.teams;
    }
    /**
     ...
     */
    public void setTeams(@jakarta.annotation.Nullable final java.util.List<ApiUserTeamMembership> value) {
        this.teams = value;
    }
    /**
