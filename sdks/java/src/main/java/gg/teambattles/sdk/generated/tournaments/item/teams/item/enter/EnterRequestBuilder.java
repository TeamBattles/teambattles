package gg.teambattles.sdk.generated.tournaments.item.teams.item.enter;
...
public class EnterRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link EnterRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public EnterRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tournaments/{identifier}/teams/{teamIdentifier}/enter", pathParameters);
    }
    /**
     * Instantiates a new {@link EnterRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public EnterRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tournaments/{identifier}/teams/{teamIdentifier}/enter", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public EnterRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new EnterRequestBuilder(rawUrl, requestAdapter);
    }
    /**
