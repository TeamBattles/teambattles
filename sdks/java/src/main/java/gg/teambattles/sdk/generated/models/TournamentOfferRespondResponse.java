...
public class TournamentOfferRespondResponse implements Parsable {
    /**
    ...
    public static TournamentOfferRespondResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
