...
public class ApplyRuleTemplateResponse implements Parsable {
    /**
    ...
    public static ApplyRuleTemplateResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ApplyRuleTemplateResponse();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("rulesId", (n) -> { this.setRulesId(n.getStringValue()); });
     ...
     */
    public void setRulesId(@jakarta.annotation.Nullable final String value) {
        this.rulesId = value;
    }
    /**
