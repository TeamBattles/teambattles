...
public class CreateMatchResponse implements Parsable {
    /**
    ...
    public static CreateMatchResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
