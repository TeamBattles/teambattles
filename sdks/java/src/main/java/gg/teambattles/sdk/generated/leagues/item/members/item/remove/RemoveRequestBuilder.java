package gg.teambattles.sdk.generated.leagues.item.members.item.remove;
...
import gg.teambattles.sdk.generated.models.RemoveLeagueMemberResponse;
...
public class RemoveRequestBuilder extends BaseRequestBuilder {
    ...
    public RemoveRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/members/{memberId}/remove", pathParameters);
    }
    /**
     * Instantiates a new {@link RemoveRequestBuilder} and sets the default values.
    ...
    public RemoveRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/members/{memberId}/remove", rawUrl);
    }
    /**
     ...
     * @return a {@link RemoveLeagueMemberResponse}
    ...
    public RemoveLeagueMemberResponse post() {
        return post(null);
    }
    /**
     * Deactivates a league staff membership. Requires a league-operator key bound to the league and the league members capability.
     ...
     */
    @jakarta.annotation.Nullable
    public RemoveLeagueMemberResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, RemoveLeagueMemberResponse::createFromDiscriminatorValue);
    }
    /**
     * Deactivates a league staff membership. Requires a league-operator key bound to the league and the league members capability.
