...
public class TournamentCloseRegistrationResponse implements Parsable {
    /**
    ...
    public static TournamentCloseRegistrationResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
