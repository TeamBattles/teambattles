...
public class CreateLeagueTicketResponse implements Parsable {
    /**
    ...
    public static CreateLeagueTicketResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
