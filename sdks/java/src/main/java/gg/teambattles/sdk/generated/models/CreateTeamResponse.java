...
public class CreateTeamResponse implements Parsable {
    /**
     * The created team ID.
     */
    private String id;
    ...
    public static CreateTeamResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
