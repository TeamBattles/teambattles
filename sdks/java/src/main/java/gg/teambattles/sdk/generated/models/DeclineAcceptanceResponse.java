...
public class DeclineAcceptanceResponse implements Parsable {
    /**
    ...
    public static DeclineAcceptanceResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
