...
public class SetTeamMemberRoleResponse implements Parsable {
    /**
    ...
    public static SetTeamMemberRoleResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
