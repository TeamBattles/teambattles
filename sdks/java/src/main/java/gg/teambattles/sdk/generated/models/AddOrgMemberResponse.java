...
public class AddOrgMemberResponse implements Parsable {
    /**
    ...
    public static AddOrgMemberResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AddOrgMemberResponse();
    }
    /**
