...
public class CreatePenaltyResponse implements Parsable {
    /**
    ...
    public static CreatePenaltyResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("penaltyId", (n) -> { this.setPenaltyId(n.getStringValue()); });
     ...
     */
    public void setPenaltyId(@jakarta.annotation.Nullable final String value) {
