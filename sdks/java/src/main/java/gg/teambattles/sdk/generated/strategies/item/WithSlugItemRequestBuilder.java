package gg.teambattles.sdk.generated.strategies.item;
...
import gg.teambattles.sdk.generated.models.ApiStrategyEnvelope;
import gg.teambattles.sdk.generated.models.Error;
import gg.teambattles.sdk.generated.strategies.item.shapes.ShapesRequestBuilder;
...
public class WithSlugItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ShapesRequestBuilder shapes() {
        return new ShapesRequestBuilder(pathParameters, requestAdapter);
    }
    /**
     * Instantiates a new {@link WithSlugItemRequestBuilder} and sets the default values.
    ...
    public WithSlugItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/strategies/{slug}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithSlugItemRequestBuilder} and sets the default values.
    ...
    public WithSlugItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/strategies/{slug}", rawUrl);
    }
    /**
    ...
    public ApiStrategyEnvelope get() {
        return get(null);
    }
    /**
     * Returns a shareable strategy resolved by its public share slug. Public and unlisted strategies are returned to any caller; a private strategy returns 404 unless the API key owner owns it. Requires strategies.read.
     ...
     */
    @jakarta.annotation.Nullable
    public ApiStrategyEnvelope get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, ApiStrategyEnvelope::createFromDiscriminatorValue);
    }
    /**
     * Returns a shareable strategy resolved by its public share slug. Public and unlisted strategies are returned to any caller; a private strategy returns 404 unless the API key owner owns it. Requires strategies.read.
