...
public class GameSeriesScore implements Parsable {
    /**
    ...
    public static GameSeriesScore createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
