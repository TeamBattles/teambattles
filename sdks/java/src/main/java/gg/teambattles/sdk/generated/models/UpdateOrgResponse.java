...
public class UpdateOrgResponse implements Parsable {
    /**
    ...
    public static UpdateOrgResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
