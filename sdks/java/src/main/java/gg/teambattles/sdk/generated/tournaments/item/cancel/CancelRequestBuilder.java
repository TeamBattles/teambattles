package gg.teambattles.sdk.generated.tournaments.item.cancel;
...
import gg.teambattles.sdk.generated.models.TournamentCancelRequestBody;
import gg.teambattles.sdk.generated.models.TournamentCancelResponse;
...
public class CancelRequestBuilder extends BaseRequestBuilder {
    ...
    public CancelRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tournaments/{identifier}/cancel", pathParameters);
    }
    /**
     * Instantiates a new {@link CancelRequestBuilder} and sets the default values.
    ...
    public CancelRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tournaments/{identifier}/cancel", rawUrl);
    }
    /**
    ...
    public TournamentCancelResponse post(@jakarta.annotation.Nonnull final TournamentCancelRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public TournamentCancelResponse post(@jakarta.annotation.Nonnull final TournamentCancelRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, TournamentCancelResponse::createFromDiscriminatorValue);
    }
    /**
     * Cancels a tournament. IRREVERSIBLE - there is no un-cancel, and a COMPLETED or already CANCELLED tournament answers 400. Cancelling delists the tournament, emits a `tournament.cancelled` webhook, system-cancels every non-terminal generated match with no forfeit penalty, and notifies the captains of every approved participant. It does NOT change the approval status, so the response reports lifecycle status and approval status as independent fields. Requires an API key holding the tournaments lifecycle capability whose owner is a tournament ADMIN - a tournamentStaff MODERATOR is NOT sufficient and receives 403.
     * @param body Tournament cancellation payload.
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final TournamentCancelRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final TournamentCancelRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
