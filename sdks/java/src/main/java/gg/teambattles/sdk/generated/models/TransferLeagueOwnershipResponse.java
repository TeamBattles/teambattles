...
public class TransferLeagueOwnershipResponse implements Parsable {
    /**
    ...
    public static TransferLeagueOwnershipResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
