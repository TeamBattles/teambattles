...
public class UpdateLeagueTicketResponse implements Parsable {
    /**
    ...
    public static UpdateLeagueTicketResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
