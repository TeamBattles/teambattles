package gg.teambattles.sdk.generated.leagues.item.tickets.item.reply;
...
import gg.teambattles.sdk.generated.models.ReplyLeagueTicketRequestBody;
import gg.teambattles.sdk.generated.models.ReplyLeagueTicketResponse;
...
public class ReplyRequestBuilder extends BaseRequestBuilder {
    ...
    public ReplyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/tickets/{ticketId}/reply", pathParameters);
    }
    /**
     * Instantiates a new {@link ReplyRequestBuilder} and sets the default values.
    ...
    public ReplyLeagueTicketResponse post(@jakarta.annotation.Nonnull final ReplyLeagueTicketRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ReplyLeagueTicketResponse post(@jakarta.annotation.Nonnull final ReplyLeagueTicketRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ReplyLeagueTicketRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ReplyLeagueTicketRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
