...
public class TournamentFreeAgencyJoinBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String note;
    /**
     * Instantiates a new {@link TournamentFreeAgencyJoinBody} and sets the default values.
     */
    public TournamentFreeAgencyJoinBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link TournamentFreeAgencyJoinBody}
     */
    @jakarta.annotation.Nonnull
    public static TournamentFreeAgencyJoinBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
