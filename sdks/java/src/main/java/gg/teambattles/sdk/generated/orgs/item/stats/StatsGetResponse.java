...
import gg.teambattles.sdk.generated.models.ApiOrganizationStats;
...
public class StatsGetResponse implements Parsable {
     ...
     */
    private ApiOrganizationStats stats;
    /**
     * ISO 8601 timestamp.
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("stats", (n) -> { this.setStats(n.getObjectValue(ApiOrganizationStats::createFromDiscriminatorValue)); });
    ...
    public ApiOrganizationStats getStats() {
        return this.stats;
    }
    /**
     ...
     */
    public void setStats(@jakarta.annotation.Nullable final ApiOrganizationStats value) {
        this.stats = value;
    }
    /**
