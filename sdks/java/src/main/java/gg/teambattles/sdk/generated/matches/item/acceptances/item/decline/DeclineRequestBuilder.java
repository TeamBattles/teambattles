package gg.teambattles.sdk.generated.matches.item.acceptances.item.decline;
...
import gg.teambattles.sdk.generated.models.DeclineAcceptanceRequestBody;
import gg.teambattles.sdk.generated.models.DeclineAcceptanceResponse;
...
public class DeclineRequestBuilder extends BaseRequestBuilder {
    ...
    public DeclineRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/matches/{matchId}/acceptances/{acceptanceId}/decline", pathParameters);
    }
    /**
     * Instantiates a new {@link DeclineRequestBuilder} and sets the default values.
    ...
    public DeclineAcceptanceResponse post(@jakarta.annotation.Nonnull final DeclineAcceptanceRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DeclineAcceptanceResponse post(@jakarta.annotation.Nonnull final DeclineAcceptanceRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeclineAcceptanceRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeclineAcceptanceRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
