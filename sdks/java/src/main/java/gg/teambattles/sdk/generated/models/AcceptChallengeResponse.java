...
public class AcceptChallengeResponse implements Parsable {
    /**
    ...
    public static AcceptChallengeResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
