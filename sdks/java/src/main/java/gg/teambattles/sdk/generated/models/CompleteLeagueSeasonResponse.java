...
public class CompleteLeagueSeasonResponse implements Parsable {
    /**
    ...
    public static CompleteLeagueSeasonResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
