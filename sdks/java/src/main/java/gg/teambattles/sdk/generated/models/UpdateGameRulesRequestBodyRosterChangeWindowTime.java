...
public class UpdateGameRulesRequestBodyRosterChangeWindowTime implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link UpdateGameRulesRequestBodyRosterChangeWindowTime} and sets the default values.
     */
    public UpdateGameRulesRequestBodyRosterChangeWindowTime() {
    ...
    public static UpdateGameRulesRequestBodyRosterChangeWindowTime createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UpdateGameRulesRequestBodyRosterChangeWindowTime();
    }
    /**
