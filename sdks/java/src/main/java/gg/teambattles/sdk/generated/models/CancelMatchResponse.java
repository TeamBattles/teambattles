...
public class CancelMatchResponse implements Parsable {
    /**
    ...
    public static CancelMatchResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
