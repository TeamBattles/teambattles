...
public class CreateOrgBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String tag;
    /**
     * Instantiates a new {@link CreateOrgBody} and sets the default values.
     */
    public CreateOrgBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link CreateOrgBody}
     */
    @jakarta.annotation.Nonnull
    public static CreateOrgBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
