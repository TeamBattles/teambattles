package gg.teambattles.sdk.generated.leaderboards.teams;
...
import gg.teambattles.sdk.generated.leaderboards.teams.item.WithIdentifierItemRequestBuilder;
import gg.teambattles.sdk.generated.models.Error;
import gg.teambattles.sdk.generated.models.LeaderboardSortBy;
import gg.teambattles.sdk.generated.models.TeamLeaderboardResponse;
...
public class TeamsRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the gg.teambattles.sdk.generated.leaderboards.teams.item collection
    ...
    public TeamsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leaderboards/teams{?gameSlug*,limit*,sortBy*}", pathParameters);
    }
    /**
     * Instantiates a new {@link TeamsRequestBuilder} and sets the default values.
    ...
    public TeamsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leaderboards/teams{?gameSlug*,limit*,sortBy*}", rawUrl);
    }
    /**
    ...
    public TeamLeaderboardResponse get() {
        return get(null);
    }
    /**
     * Returns active, non-disabled, non-private teams ranked by the requested stat. Requires teams.profile:read.
     ...
     */
    @jakarta.annotation.Nullable
    public TeamLeaderboardResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, TeamLeaderboardResponse::createFromDiscriminatorValue);
    }
    /**
     * Returns active, non-disabled, non-private teams ranked by the requested stat. Requires teams.profile:read.
