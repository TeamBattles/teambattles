...
public class RemoveLeagueTeamResponse implements Parsable {
    /**
    ...
    public static RemoveLeagueTeamResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
