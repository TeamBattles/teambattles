...
public class ClearCooldownResponse implements Parsable {
    /**
    ...
    public static ClearCooldownResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ClearCooldownResponse();
    }
    /**
