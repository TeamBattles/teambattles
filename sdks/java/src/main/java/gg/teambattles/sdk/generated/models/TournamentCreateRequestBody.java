...
public class TournamentCreateRequestBody implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private TournamentDefaultMatchConfig defaultMatchConfig;
    /**
     ...
     */
    private Boolean freeAgentsEnabled;
    /**
     * Convex game id.
     */
     ...
     */
    private TournamentCreateRequestBodyHostType hostType;
    /**
     ...
     */
    private TournamentCreateRequestBodyRegistrationMode registrationMode;
    /**
     * Unix ms.
     */
     ...
     */
    private TournamentCreateRequestBodySeedingMethod seedingMethod;
    /**
     ...
     */
    private TournamentCreateRequestBodyVisibility visibility;
    /**
     * Instantiates a new {@link TournamentCreateRequestBody} and sets the default values.
     */
     ...
     * @return a {@link TournamentCreateRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static TournamentCreateRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @jakarta.annotation.Nullable
    public TournamentDefaultMatchConfig getDefaultMatchConfig() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("defaultMatchConfig", (n) -> { this.setDefaultMatchConfig(n.getObjectValue(TournamentDefaultMatchConfig::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("freeAgentsEnabled", (n) -> { this.setFreeAgentsEnabled(n.getBooleanValue()); });
        deserializerMap.put("gameId", (n) -> { this.setGameId(n.getStringValue()); });
        deserializerMap.put("hostId", (n) -> { this.setHostId(n.getStringValue()); });
        deserializerMap.put("hostType", (n) -> { this.setHostType(n.getEnumValue(TournamentCreateRequestBodyHostType::forValue)); });
        ...
        deserializerMap.put("registrationMode", (n) -> { this.setRegistrationMode(n.getEnumValue(TournamentCreateRequestBodyRegistrationMode::forValue)); });
        ...
        deserializerMap.put("seedingMethod", (n) -> { this.setSeedingMethod(n.getEnumValue(TournamentCreateRequestBodySeedingMethod::forValue)); });
        ...
        deserializerMap.put("visibility", (n) -> { this.setVisibility(n.getEnumValue(TournamentCreateRequestBodyVisibility::forValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public Boolean getFreeAgentsEnabled() {
     ...
     * @return a {@link TournamentCreateRequestBodyHostType}
     */
    @jakarta.annotation.Nullable
    public TournamentCreateRequestBodyHostType getHostType() {
     ...
     * @return a {@link TournamentCreateRequestBodyRegistrationMode}
     */
    @jakarta.annotation.Nullable
    public TournamentCreateRequestBodyRegistrationMode getRegistrationMode() {
     ...
     * @return a {@link TournamentCreateRequestBodySeedingMethod}
     */
    @jakarta.annotation.Nullable
    public TournamentCreateRequestBodySeedingMethod getSeedingMethod() {
     ...
     * @return a {@link TournamentCreateRequestBodyVisibility}
     */
    @jakarta.annotation.Nullable
    public TournamentCreateRequestBodyVisibility getVisibility() {
     ...
     */
    public void setDefaultMatchConfig(@jakarta.annotation.Nullable final TournamentDefaultMatchConfig value) {
     ...
     */
    public void setFreeAgentsEnabled(@jakarta.annotation.Nullable final Boolean value) {
     ...
     */
    public void setHostId(@jakarta.annotation.Nullable final String value) {
        this.hostId = value;
    }
    /**
     ...
     */
    public void setHostType(@jakarta.annotation.Nullable final TournamentCreateRequestBodyHostType value) {
        this.hostType = value;
    }
    /**
     ...
     */
    public void setRegistrationMode(@jakarta.annotation.Nullable final TournamentCreateRequestBodyRegistrationMode value) {
     ...
     */
    public void setSeedingMethod(@jakarta.annotation.Nullable final TournamentCreateRequestBodySeedingMethod value) {
     ...
     */
    public void setVisibility(@jakarta.annotation.Nullable final TournamentCreateRequestBodyVisibility value) {
