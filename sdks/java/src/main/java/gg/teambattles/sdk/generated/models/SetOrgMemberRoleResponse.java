...
public class SetOrgMemberRoleResponse implements Parsable {
    /**
    ...
    public static SetOrgMemberRoleResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
