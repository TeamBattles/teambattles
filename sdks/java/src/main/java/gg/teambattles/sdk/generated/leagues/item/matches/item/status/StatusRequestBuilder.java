package gg.teambattles.sdk.generated.leagues.item.matches.item.status;
...
import gg.teambattles.sdk.generated.models.LeagueStatusUpdateBody;
...
public class StatusRequestBuilder extends BaseRequestBuilder {
    ...
    public StatusRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/matches/{matchId}/status", pathParameters);
    }
    /**
     * Instantiates a new {@link StatusRequestBuilder} and sets the default values.
    ...
    public GameStatusUpdateResponse patch(@jakarta.annotation.Nonnull final LeagueStatusUpdateBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public GameStatusUpdateResponse patch(@jakarta.annotation.Nonnull final LeagueStatusUpdateBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final LeagueStatusUpdateBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final LeagueStatusUpdateBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
