...
import gg.teambattles.sdk.generated.models.ApiTeamProfile;
...
public class WithIdentifierGetResponse implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("team", (n) -> { this.setTeam(n.getObjectValue(ApiTeamProfile::createFromDiscriminatorValue)); });
     ...
     */
    public void setTeam(@jakarta.annotation.Nullable final ApiTeamProfile value) {
        this.team = value;
    }
    /**
