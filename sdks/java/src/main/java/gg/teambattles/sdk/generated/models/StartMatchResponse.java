...
public class StartMatchResponse implements Parsable {
    /**
    ...
    public static StartMatchResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
