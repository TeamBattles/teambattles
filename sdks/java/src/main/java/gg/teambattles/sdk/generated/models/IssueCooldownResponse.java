...
public class IssueCooldownResponse implements Parsable {
    /**
    ...
    public static IssueCooldownResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("cooldownId", (n) -> { this.setCooldownId(n.getStringValue()); });
     ...
     */
    public void setCooldownId(@jakarta.annotation.Nullable final String value) {
