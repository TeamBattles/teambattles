package gg.teambattles.sdk.generated.leagues.item.bans.item.revoke;
...
import gg.teambattles.sdk.generated.models.RevokeBanRequestBody;
import gg.teambattles.sdk.generated.models.RevokeBanResponse;
...
public class RevokeRequestBuilder extends BaseRequestBuilder {
    ...
    public RevokeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/bans/{banId}/revoke", pathParameters);
    }
    /**
     * Instantiates a new {@link RevokeRequestBuilder} and sets the default values.
    ...
    public RevokeBanResponse post(@jakarta.annotation.Nonnull final RevokeBanRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public RevokeBanResponse post(@jakarta.annotation.Nonnull final RevokeBanRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final RevokeBanRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final RevokeBanRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
