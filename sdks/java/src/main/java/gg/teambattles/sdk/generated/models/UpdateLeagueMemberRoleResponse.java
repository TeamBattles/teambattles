...
public class UpdateLeagueMemberRoleResponse implements Parsable {
    /**
    ...
    public static UpdateLeagueMemberRoleResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
