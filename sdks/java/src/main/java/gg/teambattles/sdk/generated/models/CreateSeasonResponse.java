...
public class CreateSeasonResponse implements Parsable {
    /**
    ...
    public static CreateSeasonResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
