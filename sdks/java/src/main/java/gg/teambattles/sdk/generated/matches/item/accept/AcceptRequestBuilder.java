package gg.teambattles.sdk.generated.matches.item.accept;
...
import gg.teambattles.sdk.generated.models.AcceptMatchRequestBody;
import gg.teambattles.sdk.generated.models.AcceptMatchResponse;
...
public class AcceptRequestBuilder extends BaseRequestBuilder {
    ...
    public AcceptRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/matches/{matchId}/accept", pathParameters);
    }
    /**
     * Instantiates a new {@link AcceptRequestBuilder} and sets the default values.
    ...
    public AcceptRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/matches/{matchId}/accept", rawUrl);
    }
    /**
     ...
     * @return a {@link AcceptMatchResponse}
    ...
    public AcceptMatchResponse post(@jakarta.annotation.Nonnull final AcceptMatchRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public AcceptMatchResponse post(@jakarta.annotation.Nonnull final AcceptMatchRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, AcceptMatchResponse::createFromDiscriminatorValue);
    }
    /**
     * Creates a match acceptance request as the personal API key owner. The owner must captain the accepting team and the proposed roster must satisfy existing match rules. Requires matches.user_matches:read-write and API writes access. Supports an optional `Idempotency-Key` header for safe retries.
     * @param body Creates a match acceptance request as the API key owner.
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AcceptMatchRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AcceptMatchRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
