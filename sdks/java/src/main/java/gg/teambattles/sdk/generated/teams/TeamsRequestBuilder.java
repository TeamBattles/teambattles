...
import gg.teambattles.sdk.generated.models.CreateTeamBody;
import gg.teambattles.sdk.generated.models.CreateTeamResponse;
...
public class TeamsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link CreateTeamResponse}
    ...
    public CreateTeamResponse post(@jakarta.annotation.Nonnull final CreateTeamBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public CreateTeamResponse post(@jakarta.annotation.Nonnull final CreateTeamBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, CreateTeamResponse::createFromDiscriminatorValue);
    }
    /**
     * Creates a new team as the personal API key owner. The owner must manage the owning organization. Role ceilings and cascades are enforced exactly as in the web app. Requires teams.profile:read-write and API writes access. Supports an optional `Idempotency-Key` header for safe retries.
     * @param body Creates a new team as the API key owner.
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CreateTeamBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CreateTeamBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
