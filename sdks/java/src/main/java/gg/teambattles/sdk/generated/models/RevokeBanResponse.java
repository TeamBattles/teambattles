...
public class RevokeBanResponse implements Parsable {
    /**
    ...
    public static RevokeBanResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
