...
public class RequestLeagueShutdownResponse implements Parsable {
    /**
    ...
    public static RequestLeagueShutdownResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
