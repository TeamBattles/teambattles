...
public class TournamentWriteAck implements Parsable {
    /**
    ...
    public static TournamentWriteAck createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
