...
public class UpdateTeamResponse implements Parsable {
    /**
    ...
    public static UpdateTeamResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
