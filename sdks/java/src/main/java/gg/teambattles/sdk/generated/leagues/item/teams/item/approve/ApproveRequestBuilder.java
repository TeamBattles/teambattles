package gg.teambattles.sdk.generated.leagues.item.teams.item.approve;
...
import gg.teambattles.sdk.generated.models.ApproveLeagueTeamResponse;
...
public class ApproveRequestBuilder extends BaseRequestBuilder {
    ...
    public ApproveRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/teams/{leagueTeamId}/approve", pathParameters);
    }
    /**
     * Instantiates a new {@link ApproveRequestBuilder} and sets the default values.
    ...
    public ApproveLeagueTeamResponse post() {
        return post(null);
    }
    /**
     * Approves a pending team application for the league. Requires a league-operator key bound to the league and the league teams capability.
     ...
     */
    @jakarta.annotation.Nullable
    public ApproveLeagueTeamResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
