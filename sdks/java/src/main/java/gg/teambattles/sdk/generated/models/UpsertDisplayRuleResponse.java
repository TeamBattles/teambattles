...
public class UpsertDisplayRuleResponse implements Parsable {
    /**
     * The displayRuleId property
     */
    private String displayRuleId;
    /**
    ...
    public static UpsertDisplayRuleResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("displayRuleId", (n) -> { this.setDisplayRuleId(n.getStringValue()); });
     ...
     * @param value Value to set for the displayRuleId property.
     */
    public void setDisplayRuleId(@jakarta.annotation.Nullable final String value) {
