...
public class AddLeagueMemberResponse implements Parsable {
    /**
    ...
    public static AddLeagueMemberResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AddLeagueMemberResponse();
    }
    /**
