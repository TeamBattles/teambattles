...
public class TournamentParticipantsResponse implements Parsable {
    /**
     ...
     */
    private java.util.List<TournamentParticipant> participants;
    /**
    ...
    public static TournamentParticipantsResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("participants", (n) -> { this.setParticipants(n.getCollectionOfObjectValues(TournamentParticipant::createFromDiscriminatorValue)); });
        deserializerMap.put("timestamp", (n) -> { this.setTimestamp(n.getStringValue()); });
        return deserializerMap;
    }
    /**
     * Gets the participants property value. Every participant row for the tournament, in creation order.
     * @return a {@link java.util.List<TournamentParticipant>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<TournamentParticipant> getParticipants() {
     ...
     */
    public void setParticipants(@jakarta.annotation.Nullable final java.util.List<TournamentParticipant> value) {
