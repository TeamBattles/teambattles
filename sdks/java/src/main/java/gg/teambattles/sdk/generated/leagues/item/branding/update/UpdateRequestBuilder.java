package gg.teambattles.sdk.generated.leagues.item.branding.update;
...
import gg.teambattles.sdk.generated.models.UpdateLeagueBrandingRequestBody;
import gg.teambattles.sdk.generated.models.UpdateLeagueBrandingResponse;
...
public class UpdateRequestBuilder extends BaseRequestBuilder {
    ...
    public UpdateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/branding/update", pathParameters);
    }
    /**
     * Instantiates a new {@link UpdateRequestBuilder} and sets the default values.
    ...
    public UpdateLeagueBrandingResponse post(@jakarta.annotation.Nonnull final UpdateLeagueBrandingRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public UpdateLeagueBrandingResponse post(@jakarta.annotation.Nonnull final UpdateLeagueBrandingRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UpdateLeagueBrandingRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UpdateLeagueBrandingRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
