package gg.teambattles.sdk.generated.game.matches.create;
...
import gg.teambattles.sdk.generated.models.GameCreateMatchBody;
import gg.teambattles.sdk.generated.models.GameCreateMatchResponse;
...
public class CreateRequestBuilder extends BaseRequestBuilder {
    ...
    public CreateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/game/matches/create", pathParameters);
    }
    /**
     * Instantiates a new {@link CreateRequestBuilder} and sets the default values.
    ...
    public CreateRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/game/matches/create", rawUrl);
    }
    /**
    ...
    public GameCreateMatchResponse post(@jakarta.annotation.Nonnull final GameCreateMatchBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public GameCreateMatchResponse post(@jakarta.annotation.Nonnull final GameCreateMatchBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, GameCreateMatchResponse::createFromDiscriminatorValue);
    }
    /**
     * Creates an ACCEPTED + PUBLISHED match for the API key&apos;s bound game between two active teams in that game. Requires the game.lifecycle:read-write permission. Supply an optional `Idempotency-Key` request header to make retries safe: an identical key + body replays the original response, while the same key with a different body returns 409 error_idempotency_key_conflict.
     * @param body Request body for creating a two-sided game-originated match. The match is created ACCEPTED + PUBLISHED for the key&apos;s bound game. Supports an optional Idempotency-Key header for safe retries.
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GameCreateMatchBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GameCreateMatchBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
