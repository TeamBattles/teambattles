...
public class TransferOrgOwnershipResponse implements Parsable {
    /**
    ...
    public static TransferOrgOwnershipResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
