package gg.teambattles.sdk.generated.user.connections;

import com.microsoft.kiota.serialization.Parsable;
import com.microsoft.kiota.serialization.ParseNode;
import com.microsoft.kiota.serialization.SerializationWriter;
import gg.teambattles.sdk.generated.models.ApiOwnConnection;
...
public class ConnectionsGetResponse implements Parsable {
     ...
     */
    private java.util.List<ApiOwnConnection> connections;
    /**
     * The count property
     */
     ...
     * @return a {@link java.util.List<ApiOwnConnection>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<ApiOwnConnection> getConnections() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("connections", (n) -> { this.setConnections(n.getCollectionOfObjectValues(ApiOwnConnection::createFromDiscriminatorValue)); });
     ...
     */
    public void setConnections(@jakarta.annotation.Nullable final java.util.List<ApiOwnConnection> value) {
