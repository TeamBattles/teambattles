...
import gg.teambattles.sdk.generated.models.WebhookDelivery;
import java.util.HashMap;
import java.util.Map;
import java.util.Objects;
@jakarta.annotation.Generated("com.microsoft.kiota")
public class DeliveriesGetResponse implements Parsable {
    /**
     ...
     * The page property
     */
    private java.util.List<WebhookDelivery> page;
    /**
    ...
    public static DeliveriesGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DeliveriesGetResponse();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("page", (n) -> { this.setPage(n.getCollectionOfObjectValues(WebhookDelivery::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<WebhookDelivery>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<WebhookDelivery> getPage() {
        return this.page;
    }
    /**
     ...
     */
    public void setPage(@jakarta.annotation.Nullable final java.util.List<WebhookDelivery> value) {
        this.page = value;
    }
}
