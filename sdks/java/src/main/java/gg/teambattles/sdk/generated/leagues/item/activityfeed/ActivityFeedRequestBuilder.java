package gg.teambattles.sdk.generated.leagues.item.activityfeed;
...
import gg.teambattles.sdk.generated.models.LeagueActivityFeedRequestBody;
import gg.teambattles.sdk.generated.models.LeagueActivityFeedResponse;
...
public class ActivityFeedRequestBuilder extends BaseRequestBuilder {
    ...
    public ActivityFeedRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/activity-feed", pathParameters);
    }
    /**
     * Instantiates a new {@link ActivityFeedRequestBuilder} and sets the default values.
    ...
    public LeagueActivityFeedResponse post(@jakarta.annotation.Nonnull final LeagueActivityFeedRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public LeagueActivityFeedResponse post(@jakarta.annotation.Nonnull final LeagueActivityFeedRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final LeagueActivityFeedRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final LeagueActivityFeedRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
