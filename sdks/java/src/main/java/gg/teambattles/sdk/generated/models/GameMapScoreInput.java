...
public class GameMapScoreInput implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private GameMapScoreInputPlayerStats playerStats;
    /**
     * Optional screenshot URLs supporting the reported score.
     */
    private java.util.List<String> screenshotUrls;
    /**
     * Instantiates a new {@link GameMapScoreInput} and sets the default values.
     */
     ...
     * @return a {@link GameMapScoreInput}
     */
    @jakarta.annotation.Nonnull
    public static GameMapScoreInput createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("playerStats", (n) -> { this.setPlayerStats(n.getObjectValue(GameMapScoreInputPlayerStats::createFromDiscriminatorValue)); });
     ...
     * @return a {@link GameMapScoreInputPlayerStats}
     */
    @jakarta.annotation.Nullable
    public GameMapScoreInputPlayerStats getPlayerStats() {
     ...
     */
    public void setPlayerStats(@jakarta.annotation.Nullable final GameMapScoreInputPlayerStats value) {
