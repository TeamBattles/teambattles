...
public class DeleteOrgResponse implements Parsable {
    /**
    ...
    public static DeleteOrgResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
