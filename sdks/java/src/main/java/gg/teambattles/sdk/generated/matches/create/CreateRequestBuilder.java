package gg.teambattles.sdk.generated.matches.create;
...
import gg.teambattles.sdk.generated.models.CreateMatchRequestBody;
import gg.teambattles.sdk.generated.models.CreateMatchResponse;
...
public class CreateRequestBuilder extends BaseRequestBuilder {
    ...
    public CreateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/matches/create", pathParameters);
    }
    /**
     * Instantiates a new {@link CreateRequestBuilder} and sets the default values.
    ...
    public CreateMatchResponse post(@jakarta.annotation.Nonnull final CreateMatchRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public CreateMatchResponse post(@jakarta.annotation.Nonnull final CreateMatchRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CreateMatchRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CreateMatchRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
