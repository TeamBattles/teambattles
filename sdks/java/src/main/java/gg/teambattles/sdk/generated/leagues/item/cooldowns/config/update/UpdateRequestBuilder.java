package gg.teambattles.sdk.generated.leagues.item.cooldowns.config.update;
...
import gg.teambattles.sdk.generated.models.UpdateLeagueCooldownConfigRequestBody;
import gg.teambattles.sdk.generated.models.UpdateLeagueCooldownConfigResponse;
...
public class UpdateRequestBuilder extends BaseRequestBuilder {
    ...
    public UpdateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/cooldowns/config/update", pathParameters);
    }
    /**
     * Instantiates a new {@link UpdateRequestBuilder} and sets the default values.
    ...
    public UpdateLeagueCooldownConfigResponse post(@jakarta.annotation.Nonnull final UpdateLeagueCooldownConfigRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public UpdateLeagueCooldownConfigResponse post(@jakarta.annotation.Nonnull final UpdateLeagueCooldownConfigRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UpdateLeagueCooldownConfigRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UpdateLeagueCooldownConfigRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
