...
public class TournamentApplicationsResponse implements Parsable {
    /**
     ...
     */
    private java.util.List<TournamentApplication> applications;
    /**
    ...
    public static TournamentApplicationsResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a {@link java.util.List<TournamentApplication>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<TournamentApplication> getApplications() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("applications", (n) -> { this.setApplications(n.getCollectionOfObjectValues(TournamentApplication::createFromDiscriminatorValue)); });
     ...
     */
    public void setApplications(@jakarta.annotation.Nullable final java.util.List<TournamentApplication> value) {
