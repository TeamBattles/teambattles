...
public class ApproveLeagueTeamResponse implements Parsable {
    /**
    ...
    public static ApproveLeagueTeamResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
