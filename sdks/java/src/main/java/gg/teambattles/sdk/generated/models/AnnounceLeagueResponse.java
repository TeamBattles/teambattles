...
public class AnnounceLeagueResponse implements Parsable {
    /**
    ...
    public static AnnounceLeagueResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("notified", (n) -> { this.setNotified(n.getDoubleValue()); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeDoubleValue("notified", this.getNotified());
     ...
     * @param value Value to set for the notified property.
     */
    public void setNotified(@jakarta.annotation.Nullable final Double value) {
        this.notified = value;
    }
    /**
