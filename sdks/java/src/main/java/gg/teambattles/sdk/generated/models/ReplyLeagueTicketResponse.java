...
public class ReplyLeagueTicketResponse implements Parsable {
    /**
    ...
    public static ReplyLeagueTicketResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
