...
public class RemoveLeagueGameResponse implements Parsable {
    /**
    ...
    public static RemoveLeagueGameResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
