package gg.teambattles.sdk.generated.leagues.item.members.add;
...
import gg.teambattles.sdk.generated.models.AddLeagueMemberRequestBody;
import gg.teambattles.sdk.generated.models.AddLeagueMemberResponse;
...
public class AddRequestBuilder extends BaseRequestBuilder {
    ...
    public AddRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/members/add", pathParameters);
    }
    /**
     * Instantiates a new {@link AddRequestBuilder} and sets the default values.
    ...
    public AddLeagueMemberResponse post(@jakarta.annotation.Nonnull final AddLeagueMemberRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public AddLeagueMemberResponse post(@jakarta.annotation.Nonnull final AddLeagueMemberRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AddLeagueMemberRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AddLeagueMemberRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
