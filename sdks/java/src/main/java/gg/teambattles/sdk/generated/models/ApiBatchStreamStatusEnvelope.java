...
public class ApiBatchStreamStatusEnvelope implements Parsable {
    /**
     * The count property
     */
     ...
     */
    private java.util.List<ApiBatchStreamStatus> statuses;
    /**
     * ISO 8601 timestamp.
     */
    ...
    public static ApiBatchStreamStatusEnvelope createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("statuses", (n) -> { this.setStatuses(n.getCollectionOfObjectValues(ApiBatchStreamStatus::createFromDiscriminatorValue)); });
        deserializerMap.put("timestamp", (n) -> { this.setTimestamp(n.getStringValue()); });
        return deserializerMap;
    }
    /**
     * Gets the statuses property value. The statuses property
     * @return a {@link java.util.List<ApiBatchStreamStatus>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<ApiBatchStreamStatus> getStatuses() {
     ...
     */
    public void setStatuses(@jakarta.annotation.Nullable final java.util.List<ApiBatchStreamStatus> value) {
        this.statuses = value;
    }
    /**
