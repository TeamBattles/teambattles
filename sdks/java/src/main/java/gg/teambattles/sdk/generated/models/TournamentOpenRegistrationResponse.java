...
public class TournamentOpenRegistrationResponse implements Parsable {
    /**
    ...
    public static TournamentOpenRegistrationResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
