...
public class RuleWriteResponse implements Parsable {
    /**
    ...
    public static RuleWriteResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
