package gg.teambattles.sdk.generated.leagues.item.rules;
...
public class RulesRequestBuilder extends BaseRequestBuilder {
    ...
    public RulesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/rules", pathParameters);
    }
    /**
     * Instantiates a new {@link RulesRequestBuilder} and sets the default values.
    ...
    public RulesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/rules", rawUrl);
    }
    /**
    ...
    public LeagueRules post(@jakarta.annotation.Nonnull final RulesRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public LeagueRules post(@jakarta.annotation.Nonnull final RulesRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, LeagueRules::createFromDiscriminatorValue);
    }
    /**
     * Returns the game rules and points configuration for a league + game, resolved by league slug. Requires the leagues.league_public:read permission.
     * @param body Game selector for league rules and points config.
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final RulesRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final RulesRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
