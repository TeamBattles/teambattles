...
public class RemoveTeamMemberResponse implements Parsable {
    /**
    ...
    public static RemoveTeamMemberResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
