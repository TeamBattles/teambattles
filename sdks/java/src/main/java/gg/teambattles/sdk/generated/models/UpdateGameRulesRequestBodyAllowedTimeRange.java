...
public class UpdateGameRulesRequestBodyAllowedTimeRange implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link UpdateGameRulesRequestBodyAllowedTimeRange} and sets the default values.
     */
    public UpdateGameRulesRequestBodyAllowedTimeRange() {
    ...
    public static UpdateGameRulesRequestBodyAllowedTimeRange createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UpdateGameRulesRequestBodyAllowedTimeRange();
    }
    /**
