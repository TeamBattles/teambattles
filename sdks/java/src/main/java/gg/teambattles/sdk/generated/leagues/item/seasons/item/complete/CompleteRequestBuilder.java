package gg.teambattles.sdk.generated.leagues.item.seasons.item.complete;
...
import gg.teambattles.sdk.generated.models.CompleteLeagueSeasonResponse;
...
public class CompleteRequestBuilder extends BaseRequestBuilder {
    ...
    public CompleteRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/seasons/{seasonId}/complete", pathParameters);
    }
    /**
     * Instantiates a new {@link CompleteRequestBuilder} and sets the default values.
    ...
    public CompleteLeagueSeasonResponse post() {
        return post(null);
    }
    /**
     * Completes an active league season. Requires the league seasons capability. Replays are not deduped; existing state guards return the current state error if the season is no longer active.
     ...
     */
    @jakarta.annotation.Nullable
    public CompleteLeagueSeasonResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
