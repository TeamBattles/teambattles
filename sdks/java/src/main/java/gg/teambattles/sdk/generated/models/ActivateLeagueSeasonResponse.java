...
public class ActivateLeagueSeasonResponse implements Parsable {
    /**
    ...
    public static ActivateLeagueSeasonResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
