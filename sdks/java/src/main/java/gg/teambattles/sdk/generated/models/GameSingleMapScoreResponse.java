...
public class GameSingleMapScoreResponse implements Parsable {
    /**
    ...
    public static GameSingleMapScoreResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
