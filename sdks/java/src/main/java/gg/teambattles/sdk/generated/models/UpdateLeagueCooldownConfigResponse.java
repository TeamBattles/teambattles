...
public class UpdateLeagueCooldownConfigResponse implements Parsable {
    /**
    ...
    public static UpdateLeagueCooldownConfigResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
