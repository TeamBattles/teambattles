...
public class DisbandTeamResponse implements Parsable {
    /**
    ...
    public static DisbandTeamResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DisbandTeamResponse();
    }
    /**
