package gg.teambattles.sdk.generated.leagues.item.dashboard.stats;
...
import gg.teambattles.sdk.generated.models.LeagueDashboardStatsResponse;
...
public class StatsRequestBuilder extends BaseRequestBuilder {
    ...
    public StatsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/dashboard/stats", pathParameters);
    }
    /**
     * Instantiates a new {@link StatsRequestBuilder} and sets the default values.
    ...
    public LeagueDashboardStatsResponse post() {
        return post(null);
    }
    /**
     * Returns aggregate league admin dashboard counts. Requires a league-operator key bound to the league and leagues.league_admin:read.
     ...
     */
    @jakarta.annotation.Nullable
    public LeagueDashboardStatsResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
