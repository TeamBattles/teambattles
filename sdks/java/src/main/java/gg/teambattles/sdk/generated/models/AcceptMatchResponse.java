...
public class AcceptMatchResponse implements Parsable {
    /**
    ...
    public static AcceptMatchResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("acceptanceId", (n) -> { this.setAcceptanceId(n.getStringValue()); });
     ...
     * @param value Value to set for the acceptanceId property.
     */
    public void setAcceptanceId(@jakarta.annotation.Nullable final String value) {
