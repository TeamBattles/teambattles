...
public class DeleteLeagueSeasonResponse implements Parsable {
    /**
    ...
    public static DeleteLeagueSeasonResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
