package gg.teambattles.sdk.generated.leagues.item.members.item.role;
...
import gg.teambattles.sdk.generated.models.UpdateLeagueMemberRoleRequestBody;
import gg.teambattles.sdk.generated.models.UpdateLeagueMemberRoleResponse;
...
public class RoleRequestBuilder extends BaseRequestBuilder {
    ...
    public RoleRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/members/{memberId}/role", pathParameters);
    }
    /**
     * Instantiates a new {@link RoleRequestBuilder} and sets the default values.
    ...
    public UpdateLeagueMemberRoleResponse post(@jakarta.annotation.Nonnull final UpdateLeagueMemberRoleRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public UpdateLeagueMemberRoleResponse post(@jakarta.annotation.Nonnull final UpdateLeagueMemberRoleRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UpdateLeagueMemberRoleRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UpdateLeagueMemberRoleRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
