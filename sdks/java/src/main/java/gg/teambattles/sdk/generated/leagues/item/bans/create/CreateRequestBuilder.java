package gg.teambattles.sdk.generated.leagues.item.bans.create;
...
import gg.teambattles.sdk.generated.models.CreateBanRequestBody;
import gg.teambattles.sdk.generated.models.CreateBanResponse;
...
public class CreateRequestBuilder extends BaseRequestBuilder {
    ...
    public CreateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leagues/{identifier}/bans/create", pathParameters);
    }
    /**
     * Instantiates a new {@link CreateRequestBuilder} and sets the default values.
    ...
    public CreateBanResponse post(@jakarta.annotation.Nonnull final CreateBanRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public CreateBanResponse post(@jakarta.annotation.Nonnull final CreateBanRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CreateBanRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CreateBanRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
