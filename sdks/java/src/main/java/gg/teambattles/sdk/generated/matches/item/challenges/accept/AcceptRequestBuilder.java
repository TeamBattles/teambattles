package gg.teambattles.sdk.generated.matches.item.challenges.accept;
...
import gg.teambattles.sdk.generated.models.AcceptChallengeRequestBody;
import gg.teambattles.sdk.generated.models.AcceptChallengeResponse;
...
public class AcceptRequestBuilder extends BaseRequestBuilder {
    ...
    public AcceptRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/matches/{matchId}/challenges/accept", pathParameters);
    }
    /**
     * Instantiates a new {@link AcceptRequestBuilder} and sets the default values.
    ...
    public AcceptChallengeResponse post(@jakarta.annotation.Nonnull final AcceptChallengeRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public AcceptChallengeResponse post(@jakarta.annotation.Nonnull final AcceptChallengeRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AcceptChallengeRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AcceptChallengeRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
