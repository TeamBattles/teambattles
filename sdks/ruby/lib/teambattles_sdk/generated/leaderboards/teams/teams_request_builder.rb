...
require_relative '../../models/team_leaderboard_response'
        ...
        module Leaderboards
            module Teams
                ...
                class TeamsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## 
                    ## Gets an item from the TeamBattlesSdk::Generated.leaderboards.teams.item collection
                    ...
                    def by_identifier(identifier)
                        ...
                        return TeamBattlesSdk::Generated::Leaderboards::Teams::Item::WithIdentifierItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/leaderboards/teams{?gameSlug*,limit*,sortBy*}")
                    end
                    ## 
                    ...
                    ## @return a Fiber of team_leaderboard_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::TeamLeaderboardResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Returns active, non-disabled, non-private teams ranked by the requested stat. Requires teams.profile:read.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
