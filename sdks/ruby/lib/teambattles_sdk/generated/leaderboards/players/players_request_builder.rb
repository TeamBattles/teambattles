...
require_relative '../../models/player_leaderboard_response'
        ...
        module Leaderboards
            module Players
                ...
                class PlayersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    # The me property
                    def me()
                        return TeamBattlesSdk::Generated::Leaderboards::Players::Me::MeRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ##
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/leaderboards/players{?limit*,sortBy*}")
                    end
                    ##
                    ...
                    ## @return a Fiber of player_leaderboard_response
                    ##
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::PlayerLeaderboardResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ##
                    ## Returns the global player leaderboard. gameSlug is rejected because player stats are global. Requires users.profile:read.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
