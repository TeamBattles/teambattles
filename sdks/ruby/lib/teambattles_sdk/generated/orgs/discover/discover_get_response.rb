...
require_relative '../../models/api_organization_summary'
        ...
        module Orgs
            module Discover
                ...
                class DiscoverGetResponse
                    ...
                    ## @return a discover_get_response
                    ##
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return DiscoverGetResponse.new
                    end
                    ##
                    ...
                    def get_field_deserializers()
                        return {
                            ...
                            "organizations" => lambda {|n| @organizations = n.get_collection_of_object_values(lambda {|pn| TeamBattlesSdk::Generated::Models::ApiOrganizationSummary.create_from_discriminator_value(pn) }) },
