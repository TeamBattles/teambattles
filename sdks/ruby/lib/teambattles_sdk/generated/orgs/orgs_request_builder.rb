...
require_relative '../models/create_org_body'
require_relative '../models/create_org_response'
    ...
    module Generated
        module Orgs
            ...
            class OrgsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                ## @return a Fiber of create_org_response
                ## 
                def post(body, request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::CreateOrgResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## Creates a new organization as the personal API key owner. The owner becomes the organization owner. Role ceilings and cascades are enforced exactly as in the web app. Requires orgs.profile:read-write and API writes access. Supports an optional `Idempotency-Key` header for safe retries.
                ## @param body Creates a new organization as the API key owner.
                ...
                ## @return a orgs_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return OrgsRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
