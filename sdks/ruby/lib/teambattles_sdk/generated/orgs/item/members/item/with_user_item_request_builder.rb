...
require_relative '../../../../models/remove_org_member_response'
                ...
                module Members
                    module Item
                        ...
                        class WithUserItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            # The role property
                            def role()
                                return TeamBattlesSdk::Generated::Orgs::Item::Members::Item::Role::RoleRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/orgs/{identifier}/members/{userId}")
                            end
                            ## 
                            ...
                            ## @return a Fiber of remove_org_member_response
                            ## 
                            def delete(request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::RemoveOrgMemberResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Removes a member from an organization. The caller (key owner) must be an organization admin. The organization owner cannot be removed this way - transfer ownership first. Requires orgs.roster:read-write.
                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
