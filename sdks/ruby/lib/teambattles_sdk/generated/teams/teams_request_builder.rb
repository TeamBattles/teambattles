...
require_relative '../models/create_team_body'
require_relative '../models/create_team_response'
    ...
    module Generated
        module Teams
            ...
            class TeamsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                ## @return a Fiber of create_team_response
                ## 
                def post(body, request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::CreateTeamResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## Creates a new team as the personal API key owner. The owner must manage the owning organization. Role ceilings and cascades are enforced exactly as in the web app. Requires teams.profile:read-write and API writes access. Supports an optional `Idempotency-Key` header for safe retries.
                ## @param body Creates a new team as the API key owner.
