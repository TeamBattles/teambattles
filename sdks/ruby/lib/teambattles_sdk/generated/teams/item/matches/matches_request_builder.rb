                ...
                module Matches
                    ...
                    class MatchesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/teams/{identifier}/matches")
                        end
                        ## 
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Teams::Item::Matches::MatchesPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Returns matches for a specific team (resolved by id or slug), newest first, with cursor pagination. The authenticated user must be an active member of the team. Requires the matches.team_matches:read permission.
                        ## @param body Filters and cursor pagination for listing matches.
