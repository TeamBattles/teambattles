...
require_relative '../../../../../models/set_team_member_role_body'
require_relative '../../../../../models/set_team_member_role_response'
                        ...
                        module Role
                            ...
                            class RoleRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/teams/{identifier}/members/{userId}/role")
                                end
                                ## 
                                ...
                                ## @return a Fiber of set_team_member_role_response
                                ## 
                                def patch(body, request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::SetTeamMemberRoleResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
                                ## Sets a team member's role to CO_CAPTAIN or MEMBER. The caller (key owner) must be the team captain or co-captain. The captain role cannot be assigned or removed this way - use captaincy transfer instead. Requires teams.roster:read-write.
                                ## @param body Set a team member's role.
