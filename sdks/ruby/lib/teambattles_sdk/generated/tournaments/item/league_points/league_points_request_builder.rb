...
require_relative '../../../models/tournament_league_points_rejected'
require_relative '../../../models/tournament_league_points_request_body'
require_relative '../../../models/tournament_league_points_response'
require_relative '../../../team_battles_sdk::_generated'
require_relative '../../tournaments'
require_relative '../item'
require_relative './league_points'
        ...
        module Tournaments
            module Item
                module LeaguePoints
                    ...
                    class LeaguePointsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/tournaments/{identifier}/league-points")
                        end
                        ## 
                        ...
                        ## @return a Fiber of tournament_league_points_response
                        ## 
                        def post(body, request_configuration=nil)
                            ...
                            error_mapping["400"] = lambda {|pn| TeamBattlesSdk::Generated::Models::TournamentLeaguePointsRejected.create_from_discriminator_value(pn) }
                            error_mapping["401"] = lambda {|pn| TeamBattlesSdk::Generated::Models::Error.create_from_discriminator_value(pn) }
                            error_mapping["403"] = lambda {|pn| TeamBattlesSdk::Generated::Models::Error.create_from_discriminator_value(pn) }
                            error_mapping["404"] = lambda {|pn| TeamBattlesSdk::Generated::Models::Error.create_from_discriminator_value(pn) }
                            error_mapping["429"] = lambda {|pn| TeamBattlesSdk::Generated::Models::Error.create_from_discriminator_value(pn) }
                            error_mapping["500"] = lambda {|pn| TeamBattlesSdk::Generated::Models::Error.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::TournamentLeaguePointsResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Sets whether a league-hosted tournament awards league points on finalization, and the placement curve it awards them by. LEAGUE HOSTS ONLY - a tournament hosted by a user or an organization answers 400. Editable until the tournament finalizes; a COMPLETED or CANCELLED tournament answers 400. These two settings are NOT material fields, so this endpoint applies them directly and never routes them through re-approval, even on an approved tournament - that is exactly why they are not editable via the update endpoint. Requires an API key holding the tournaments lifecycle capability whose owner is a tournament ADMIN - a tournamentStaff MODERATOR is NOT sufficient and receives 403.
                        ## @param body League placement-points configuration.
                        ...
                        ## @return a league_points_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return LeaguePointsRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
