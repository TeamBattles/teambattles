...
require_relative '../../../../../models/tournament_deny_application_body'
                ...
                module Applications
                    module Item
                        module Deny
                            ...
                            class DenyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/tournaments/{identifier}/applications/{participantId}/deny")
                                end
                                ## 
                                ...
                                ## @return a deny_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return DenyRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
