...
require_relative '../../../../models/set_league_enabled_request_body'
require_relative '../../../../models/set_league_enabled_response'
            ...
            module Item
                module Settings
                    module Enabled
                        ...
                        class EnabledRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            ## @return a enabled_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return EnabledRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
