...
require_relative '../../../../../models/revoke_ban_request_body'
require_relative '../../../../../models/revoke_ban_response'
                        ...
                        module Revoke
                            ...
                            class RevokeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/leagues/{identifier}/bans/{banId}/revoke")
                                end
                                ## 
                                ...
                                ## @return a Fiber of revoke_ban_response
                                ## 
                                def post(body, request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::RevokeBanResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
                                ## Revokes an active league team ban. Requires a league-operator key bound to the league and the league bans capability.
                                ## @param body Optional reason for revoking a league ban.
