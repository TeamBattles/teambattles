...
require_relative '../../../../models/create_ban_request_body'
require_relative '../../../../models/create_ban_response'
                    ...
                    module Create
                        ...
                        class CreateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/leagues/{identifier}/bans/create")
                            end
                            ## 
                            ...
                            ## @return a Fiber of create_ban_response
                            ## 
                            def post(body, request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::CreateBanResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Bans a team from the league and removes it from active/pending league participation. Requires a league-operator key bound to the league and the league bans capability.
                            ## @param body Creates a league team ban.
