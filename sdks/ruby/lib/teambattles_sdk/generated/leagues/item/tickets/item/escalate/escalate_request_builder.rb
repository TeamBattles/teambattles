...
require_relative '../../../../../models/escalate_league_ticket_request_body'
require_relative '../../../../../models/escalate_league_ticket_response'
require_relative '../../../../../team_battles_sdk::_generated'
require_relative '../../../../leagues'
require_relative '../../../item'
require_relative '../../tickets'
require_relative '../item'
require_relative './escalate'
                ...
                module Tickets
                    module Item
                        module Escalate
                            ...
                            class EscalateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                ## @return a escalate_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return EscalateRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
