...
require_relative '../../../../models/create_league_ticket_request_body'
require_relative '../../../../models/create_league_ticket_response'
                    ...
                    module Create
                        ...
                        class CreateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/leagues/{identifier}/tickets/create")
                            end
                            ## 
                            ...
                            ## @return a Fiber of create_league_ticket_response
                            ## 
                            def post(body, request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::CreateLeagueTicketResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Creates a league-scoped support ticket. Requires a league-operator key bound to the league and the league tickets capability.
                            ## @param body Creates a league-scoped support ticket.
