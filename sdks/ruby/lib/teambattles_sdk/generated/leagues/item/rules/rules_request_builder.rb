...
require_relative '../../../models/league_rules'
require_relative '../../../models/rules_request_body'
                ...
                module Rules
                    ...
                    class RulesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/leagues/{identifier}/rules")
                        end
                        ## 
                        ...
                        ## @return a Fiber of league_rules
                        ## 
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::LeagueRules.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Returns the game rules and points configuration for a league + game, resolved by league slug. Requires the leagues.league_public:read permission.
                        ## @param body Game selector for league rules and points config.
