...
require_relative '../../../../models/rule_write_response'
require_relative '../../../../models/update_game_rules_request_body'
                    ...
                    module Update
                        ...
                        class UpdateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/leagues/{identifier}/rules/update")
                            end
                            ## 
                            ...
                            ## @return a Fiber of rule_write_response
                            ## 
                            def post(body, request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::RuleWriteResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Creates or updates enforced rules for a league game. Requires a league-operator key bound to the league and the league rules capability.
                            ## @param body Updates league game rules.
