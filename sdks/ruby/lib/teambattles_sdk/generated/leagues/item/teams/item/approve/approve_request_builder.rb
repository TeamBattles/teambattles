...
require_relative '../../../../../models/approve_league_team_response'
                        ...
                        module Approve
                            ...
                            class ApproveRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/leagues/{identifier}/teams/{leagueTeamId}/approve")
                                end
                                ## 
                                ...
                                ## @return a Fiber of approve_league_team_response
                                ## 
                                def post(request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::ApproveLeagueTeamResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
                                ## Approves a pending team application for the league. Requires a league-operator key bound to the league and the league teams capability.
                                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
