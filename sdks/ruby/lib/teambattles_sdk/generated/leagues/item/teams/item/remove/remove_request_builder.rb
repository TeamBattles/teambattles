...
require_relative '../../../../../models/remove_league_team_request_body'
require_relative '../../../../../models/remove_league_team_response'
                        ...
                        module Remove
                            ...
                            class RemoveRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/leagues/{identifier}/teams/{leagueTeamId}/remove")
                                end
                                ## 
                                ...
                                ## @return a Fiber of remove_league_team_response
                                ## 
                                def post(body, request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::RemoveLeagueTeamResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
                                ## Removes an approved team from the league. Pending matches are cancelled and ready or accepted matches are forfeited by the removed team. Requires a league-operator key bound to the league and the league teams capability.
                                ## @param body Removes an approved team from a league.
