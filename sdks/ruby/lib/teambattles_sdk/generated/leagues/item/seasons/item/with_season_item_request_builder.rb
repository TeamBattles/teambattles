...
require_relative '../../../../models/delete_league_season_response'
                ...
                module Seasons
                    module Item
                        ...
                        class WithSeasonItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def activate()
                                return TeamBattlesSdk::Generated::Leagues::Item::Seasons::Item::Activate::ActivateRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # The complete property
                            def complete()
                                return TeamBattlesSdk::Generated::Leagues::Item::Seasons::Item::Complete::CompleteRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def delete(request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::DeleteLeagueSeasonResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
