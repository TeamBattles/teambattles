...
require_relative '../../../../models/remove_league_game_response'
require_relative '../../../../team_battles_sdk::_generated'
require_relative '../../../leagues'
require_relative '../../item'
require_relative '../games'
require_relative './item'
require_relative './toggle/toggle_request_builder'
            ...
            module Item
                module Games
                    module Item
                        ...
                        class WithLeagueGameItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            
                            ## 
                            # The toggle property
                            def toggle()
                                return TeamBattlesSdk::Generated::Leagues::Item::Games::Item::Toggle::ToggleRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def with_url(raw_url)
                                ...
                                return WithLeagueGameItemRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
