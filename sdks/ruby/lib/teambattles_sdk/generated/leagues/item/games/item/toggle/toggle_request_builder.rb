...
require_relative '../../../../../models/toggle_league_game_request_body'
require_relative '../../../../../models/toggle_league_game_response'
                ...
                module Games
                    module Item
                        module Toggle
                            ...
                            class ToggleRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                ## @return a toggle_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return ToggleRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
