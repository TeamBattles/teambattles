...
require_relative '../../../../models/issue_cooldown_request_body'
require_relative '../../../../models/issue_cooldown_response'
                    ...
                    module Issue
                        ...
                        class IssueRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/leagues/{identifier}/cooldowns/issue")
                            end
                            ## 
                            ...
                            ## @return a Fiber of issue_cooldown_response
                            ## 
                            def post(body, request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::IssueCooldownResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Issues or updates a manual cooldown for a league member. Requires a league-operator key bound to the league and the league cooldowns capability.
                            ## @param body Issues or updates a manual league member cooldown.
