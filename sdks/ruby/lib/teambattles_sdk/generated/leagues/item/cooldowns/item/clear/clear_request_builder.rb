...
require_relative '../../../../../models/clear_cooldown_response'
                        ...
                        module Clear
                            ...
                            class ClearRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/leagues/{identifier}/cooldowns/{cooldownId}/clear")
                                end
                                ## 
                                ...
                                ## @return a Fiber of clear_cooldown_response
                                ## 
                                def post(request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::ClearCooldownResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
                                ## Clears an active league member cooldown early. Requires a league-operator key bound to the league and the league cooldowns capability.
                                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
