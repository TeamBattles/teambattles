...
require_relative '../../../../models/add_league_member_request_body'
require_relative '../../../../models/add_league_member_response'
                    ...
                    module Add
                        ...
                        class AddRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/leagues/{identifier}/members/add")
                            end
                            ## 
                            ...
                            ## @return a Fiber of add_league_member_response
                            ## 
                            def post(body, request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::AddLeagueMemberResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Adds or reactivates a league staff member. Requires a league-operator key bound to the league and the league members capability.
                            ## @param body Adds or reactivates a league staff member.
