...
require_relative '../../../../models/request_league_shutdown_response'
            ...
            module Item
                module Shutdown
                    module Request
                        ...
                        class RequestRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            ## @return a request_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return RequestRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
