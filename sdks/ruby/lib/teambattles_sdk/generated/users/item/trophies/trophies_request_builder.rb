        ...
        module Users
            module Item
                module Trophies
                    ...
                    class TrophiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## @return a trophies_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return TrophiesRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
