...
require_relative './stream/stream_request_builder'
        ...
        module Users
            module Item
                ...
                class WithIdentifierItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    # The stream property
                    def stream()
                        return TeamBattlesSdk::Generated::Users::Item::Stream::StreamRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # The teams property
                    def teams()
