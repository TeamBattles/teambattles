...
require_relative '../../models/my_tournaments_response'
        ...
        module User
            module Tournaments
                ...
                class TournamentsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def calendar()
                        return TeamBattlesSdk::Generated::User::Tournaments::Calendar::CalendarRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/user/tournaments")
                    end
                    ## 
                    ...
                    ## @return a Fiber of my_tournaments_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::MyTournamentsResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Returns the tournaments the API key owner hosts or holds tournament staff on, including drafts and unapproved ones. Ordered attention-first, then most recently updated, and capped at 100. Requires tournaments.tournament_admin:read - the public read scope is deliberately insufficient because this surface exposes unlisted tournaments.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
