            ...
            module Matches
                ...
                class MatchesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/user/matches")
                    end
                    ## 
                    ...
                    def post(body, request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::User::Matches::MatchesPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Returns matches the API key owner participates in, newest first, with cursor pagination. Requires the matches.user_matches:read permission.
                    ## @param body Filters and cursor pagination for listing matches.
