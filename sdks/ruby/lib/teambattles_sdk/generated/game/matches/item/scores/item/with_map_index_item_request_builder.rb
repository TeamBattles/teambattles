...
require_relative '../../../../../models/game_single_map_score_body'
require_relative '../../../../../models/game_single_map_score_response'
                ...
                module Item
                    module Scores
                        module Item
                            ...
                            class WithMapIndexItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/game/matches/{matchId}/scores/{mapIndex}")
                                end
                                ## 
                                ...
                                def with_url(raw_url)
                                    ...
                                    return WithMapIndexItemRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
