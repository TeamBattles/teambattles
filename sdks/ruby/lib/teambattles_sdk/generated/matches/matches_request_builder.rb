    ...
    module Generated
        module Matches
            ...
            class MatchesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                # The create property
                def create()
                    return TeamBattlesSdk::Generated::Matches::Create::CreateRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # The discover property
                def discover()
                    return TeamBattlesSdk::Generated::Matches::Discover::DiscoverRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
