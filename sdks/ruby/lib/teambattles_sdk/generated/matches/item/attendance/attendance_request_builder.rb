...
require_relative '../../../models/update_attendance_request_body'
require_relative '../../../models/update_attendance_response'
        ...
        module Matches
            module Item
                module Attendance
                    ...
                    class AttendanceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/matches/{matchId}/attendance")
                        end
                        ## 
                        ...
                        ## @return a Fiber of update_attendance_response
                        ## 
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::UpdateAttendanceResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Updates the personal API key owner's own attendance status for a match. The owner must already be rostered in the match; the platform may swap active and bench players automatically. Requires matches.user_matches:read-write and API writes access. Supports an optional `Idempotency-Key` header for safe retries.
                        ## @param body Updates the API key owner's own attendance status for a match.
                        ...
                        ## @return a attendance_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return AttendanceRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
