...
require_relative '../../../models/forfeit_match_request_body'
require_relative '../../../models/forfeit_match_response'
require_relative '../../../team_battles_sdk::_generated'
require_relative '../../matches'
require_relative '../item'
require_relative './forfeit'
                ...
                module Forfeit
                    ...
                    class ForfeitRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/matches/{matchId}/forfeit")
                        end
                        ## 
                        ...
                        ## @return a Fiber of forfeit_match_response
                        ## 
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::ForfeitMatchResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Forfeits a match as the personal API key owner. The owner must captain one participating team. Requires matches.user_matches:read-write and API writes access. Supports an optional `Idempotency-Key` header for safe retries.
                        ## @param body Forfeits the match as the API key owner.
