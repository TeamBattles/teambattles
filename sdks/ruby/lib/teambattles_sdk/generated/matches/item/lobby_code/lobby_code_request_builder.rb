...
require_relative '../../../models/update_lobby_code_request_body'
require_relative '../../../models/update_lobby_code_response'
require_relative '../../../team_battles_sdk::_generated'
require_relative '../../matches'
require_relative '../item'
require_relative './lobby_code'
        ...
        module Matches
            module Item
                module LobbyCode
                    ...
                    class LobbyCodeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## @return a lobby_code_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return LobbyCodeRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
