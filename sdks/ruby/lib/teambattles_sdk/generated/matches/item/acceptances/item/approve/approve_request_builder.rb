...
require_relative '../../../../../models/approve_acceptance_request_body'
require_relative '../../../../../models/approve_acceptance_response'
                        ...
                        module Approve
                            ...
                            class ApproveRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/matches/{matchId}/acceptances/{acceptanceId}/approve")
                                end
                                ## 
                                ...
                                ## @return a Fiber of approve_acceptance_response
                                ## 
                                def post(body, request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::ApproveAcceptanceResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
                                ## Approves a pending match acceptance as the personal API key owner. The owner must captain the creator team, and the acceptance must still be pending. Requires matches.user_matches:read-write and API writes access. Supports an optional `Idempotency-Key` header for safe retries.
                                ## @param body Approves a pending match acceptance as the API key owner.
