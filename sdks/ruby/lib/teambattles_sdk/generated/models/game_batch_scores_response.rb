    ...
    module Generated
        module Models
            ...
            class GameBatchScoresResponse
                ...
                ## @return a game_batch_scores_response
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return GameBatchScoresResponse.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "submitted" => lambda {|n| @submitted = n.get_collection_of_object_values(lambda {|pn| TeamBattlesSdk::Generated::Models::GameBatchScoreResult.create_from_discriminator_value(pn) }) },
