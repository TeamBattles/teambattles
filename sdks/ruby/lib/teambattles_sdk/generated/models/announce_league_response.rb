    ...
    module Generated
        module Models
            class AnnounceLeagueResponse
                ...
                ## @return a announce_league_response
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return AnnounceLeagueResponse.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return {
                        "notified" => lambda {|n| @notified = n.get_object_value(lambda {|pn| Double.create_from_discriminator_value(pn) }) },
                ...
                def serialize(writer)
                    ...
                    writer.write_object_value("notified", @notified)
