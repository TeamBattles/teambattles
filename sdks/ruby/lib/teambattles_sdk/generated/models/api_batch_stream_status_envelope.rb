...
module TeamBattlesSdk
    module Generated
        module Models
            ...
            class ApiBatchStreamStatusEnvelope
                ...
                ## @return a api_batch_stream_status_envelope
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return ApiBatchStreamStatusEnvelope.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "statuses" => lambda {|n| @statuses = n.get_collection_of_object_values(lambda {|pn| TeamBattlesSdk::Generated::Models::ApiBatchStreamStatus.create_from_discriminator_value(pn) }) },
