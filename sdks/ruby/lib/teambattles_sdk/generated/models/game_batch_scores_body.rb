    ...
    module Generated
        module Models
            ...
            class GameBatchScoresBody
                ...
                ## @return a game_batch_scores_body
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return GameBatchScoresBody.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return {
                        "maps" => lambda {|n| @maps = n.get_collection_of_object_values(lambda {|pn| TeamBattlesSdk::Generated::Models::GameMapScoreInput.create_from_discriminator_value(pn) }) },
                    }
                end
                ## 
