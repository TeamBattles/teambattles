    ...
    module Generated
        module Models
            ...
            class BansRequestBody
                ...
                ## @return a bans_request_body
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return BansRequestBody.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return {
                        "status" => lambda {|n| @status = n.get_enum_value(TeamBattlesSdk::Generated::Models::BansRequestBodyStatus) },
                    }
                end
                ## 
                ...
                ## @return a bans_request_body_status
                ## 
                def status
                    return @status
                end
