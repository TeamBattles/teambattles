    ...
    module Generated
        module Models
            ...
            class SetTeamMemberRoleBody
                ...
                ## @return a set_team_member_role_body
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return SetTeamMemberRoleBody.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return {
                        "role" => lambda {|n| @role = n.get_enum_value(TeamBattlesSdk::Generated::Models::SetTeamMemberRoleBodyRole) },
                    }
                end
                ## 
                ## Gets the role property value. The new role for the member. Captaincy is changed via captaincy transfer.
                ## @return a set_team_member_role_body_role
                ## 
                def role
                    return @role
                end
