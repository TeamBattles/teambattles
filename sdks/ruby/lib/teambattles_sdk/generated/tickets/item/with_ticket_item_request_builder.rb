...
require_relative '../../models/ticket_detail'
        ...
        module Tickets
            module Item
                ...
                class WithTicketItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def messages()
                        return TeamBattlesSdk::Generated::Tickets::Item::Messages::MessagesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/tickets/{ticketId}")
                    end
                    ## 
                    ...
                    ## @return a Fiber of ticket_detail
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::TicketDetail.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Returns one of the API key owner's tickets and its message thread (internal staff notes excluded). A ticket the owner does not own reads as 404. Requires the tickets.read scope.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
