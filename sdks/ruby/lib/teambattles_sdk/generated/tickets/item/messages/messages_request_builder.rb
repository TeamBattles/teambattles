...
require_relative '../../../models/add_ticket_message_request_body'
require_relative '../../../models/add_ticket_message_response'
                ...
                module Messages
                    ...
                    class MessagesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/tickets/{ticketId}/messages")
                        end
                        ## 
                        ...
                        ## @return a Fiber of add_ticket_message_response
                        ## 
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| TeamBattlesSdk::Generated::Models::AddTicketMessageResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Adds a reply message to one of the API key owner's tickets. Closed tickets are rejected. Requires the tickets.write scope and the writes feature. Supports the Idempotency-Key header.
                        ## @param body Adds a reply message to one of the API key owner's tickets.
