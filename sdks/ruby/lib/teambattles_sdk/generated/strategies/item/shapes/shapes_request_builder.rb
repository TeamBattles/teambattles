...
require_relative '../../../models/api_strategy_shapes_envelope'
        ...
        module Strategies
            module Item
                module Shapes
                    ...
                    class ShapesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## @return a shapes_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return ShapesRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
