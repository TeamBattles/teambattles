...
func (m *TemplatesRequestBuilder) Post(ctx context.Context, body i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.LeagueTemplatesRequestBodyable, requestConfiguration *TemplatesRequestBuilderPostRequestConfiguration)(i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.LeagueTemplatesable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.CreateLeagueTemplatesFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.LeagueTemplatesable), nil
}
