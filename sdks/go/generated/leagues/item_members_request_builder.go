...
// ByMemberId gets an item from the github.com/teambattles/sdk-go/generated.leagues.item.members.item collection
...
func (m *ItemMembersRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemMembersRequestBuilderPostRequestConfiguration)(i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.LeagueMembersable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.CreateLeagueMembersFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.LeagueMembersable), nil
}
