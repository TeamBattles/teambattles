...
// Post adds or reactivates a league staff member. Requires a personal or developer API key whose owner is currently a league ADMIN of the league in the path, with the league members capability enabled on the key. League API access is gated at api_pro on the league owner's plan.
...
func (m *ItemMembersAddRequestBuilder) Post(ctx context.Context, body i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.AddLeagueMemberRequestBodyable, requestConfiguration *ItemMembersAddRequestBuilderPostRequestConfiguration)(i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.AddLeagueMemberResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.CreateAddLeagueMemberResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.AddLeagueMemberResponseable), nil
}
// ToPostRequestInformation adds or reactivates a league staff member. Requires a personal or developer API key whose owner is currently a league ADMIN of the league in the path, with the league members capability enabled on the key. League API access is gated at api_pro on the league owner's plan.
