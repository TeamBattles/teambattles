...
// ByIdentifier gets an item from the github.com/teambattles/sdk-go/generated.users.item collection
// returns a *WithIdentifierItemRequestBuilder when successful
func (m *UsersRequestBuilder) ByIdentifier(identifier string)(*WithIdentifierItemRequestBuilder) {
