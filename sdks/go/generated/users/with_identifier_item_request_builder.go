...
// WithIdentifierItemRequestBuilder builds and executes requests for operations under \users\{identifier}
...
func (m *WithIdentifierItemRequestBuilder) Connections()(*ItemConnectionsRequestBuilder) {
...
func NewWithIdentifierItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WithIdentifierItemRequestBuilder) {
    m := &WithIdentifierItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{identifier}", pathParameters),
    }
    return m
}
...
// Get returns an API-safe user profile projection. Private profiles return only the base profile envelope. Requires users.profile:read.
...
// GetAsWithIdentifierGetResponse returns an API-safe user profile projection. Private profiles return only the base profile envelope. Requires users.profile:read.
...
func (m *WithIdentifierItemRequestBuilder) Organizations()(*ItemOrganizationsRequestBuilder) {
    return NewItemOrganizationsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// ToGetRequestInformation returns an API-safe user profile projection. Private profiles return only the base profile envelope. Requires users.profile:read.
...
// Trophies the trophies property
// returns a *ItemTrophiesRequestBuilder when successful
func (m *WithIdentifierItemRequestBuilder) Trophies()(*ItemTrophiesRequestBuilder) {
    return NewItemTrophiesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
