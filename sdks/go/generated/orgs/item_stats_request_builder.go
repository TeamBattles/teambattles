...
// ItemStatsRequestBuilder builds and executes requests for operations under \orgs\{identifier}\stats
...
func NewItemStatsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemStatsRequestBuilder) {
    m := &ItemStatsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/orgs/{identifier}/stats", pathParameters),
    }
    return m
}
