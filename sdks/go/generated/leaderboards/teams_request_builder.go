...
// TeamsRequestBuilder builds and executes requests for operations under \leaderboards\teams
type TeamsRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// TeamsRequestBuilderGetQueryParameters returns active, non-disabled, non-private teams ranked by the requested stat. Requires teams.profile:read.
...
// ByIdentifier gets an item from the github.com/teambattles/sdk-go/generated.leaderboards.teams.item collection
// returns a *TeamsWithIdentifierItemRequestBuilder when successful
func (m *TeamsRequestBuilder) ByIdentifier(identifier string)(*TeamsWithIdentifierItemRequestBuilder) {
    ...
    return NewTeamsWithIdentifierItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
...
func NewTeamsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamsRequestBuilder) {
    m := &TeamsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/leaderboards/teams{?gameSlug*,limit*,sortBy*}", pathParameters),
    }
    return m
}
...
// Get returns active, non-disabled, non-private teams ranked by the requested stat. Requires teams.profile:read.
// returns a TeamLeaderboardResponseable when successful
...
func (m *TeamsRequestBuilder) Get(ctx context.Context, requestConfiguration *TeamsRequestBuilderGetRequestConfiguration)(i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.TeamLeaderboardResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.CreateTeamLeaderboardResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i2d9c680fd9772d4e188b4eef5833f06d8e3e2a73281435f45003417856275121.TeamLeaderboardResponseable), nil
}
// ToGetRequestInformation returns active, non-disabled, non-private teams ranked by the requested stat. Requires teams.profile:read.
