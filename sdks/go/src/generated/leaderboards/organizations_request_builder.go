...
// ByIdentifier gets an item from the teambattles.leaderboards.organizations.item collection
...
func (m *OrganizationsRequestBuilder) Get(ctx context.Context, requestConfiguration *OrganizationsRequestBuilderGetRequestConfiguration)(i9ac5c274a78aacc60be5220718abbbe997d33af370bb0ebbe6aca45a8b13cfeb.OrganizationLeaderboardResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i9ac5c274a78aacc60be5220718abbbe997d33af370bb0ebbe6aca45a8b13cfeb.CreateOrganizationLeaderboardResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i9ac5c274a78aacc60be5220718abbbe997d33af370bb0ebbe6aca45a8b13cfeb.OrganizationLeaderboardResponseable), nil
}
