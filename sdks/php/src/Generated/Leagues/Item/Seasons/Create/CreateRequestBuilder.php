...
namespace TeamBattles\Sdk\Generated\Leagues\Item\Seasons\Create;
...
use TeamBattles\Sdk\Generated\Models\CreateSeasonRequestBody;
use TeamBattles\Sdk\Generated\Models\CreateSeasonResponse;
...
class CreateRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/leagues/{identifier}/seasons/create');
     ...
     * @param CreateSeasonRequestBody $body League season creation payload.
     ...
     * @return Promise<CreateSeasonResponse|null>
     * @throws Exception
    */
    public function post(CreateSeasonRequestBody $body, ?CreateRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [CreateSeasonResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toPostRequestInformation(CreateSeasonRequestBody $body, ?CreateRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
