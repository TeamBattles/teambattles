...
namespace TeamBattles\Sdk\Generated\Leagues\Item\Seasons\Item\Complete;
...
use TeamBattles\Sdk\Generated\Models\CompleteLeagueSeasonResponse;
...
class CompleteRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/leagues/{identifier}/seasons/{seasonId}/complete');
     ...
     * @return Promise<CompleteLeagueSeasonResponse|null>
     * @throws Exception
    */
    public function post(?CompleteRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [CompleteLeagueSeasonResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
