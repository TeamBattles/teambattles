...
namespace TeamBattles\Sdk\Generated\Leagues\Item\Rules\Update;
...
use TeamBattles\Sdk\Generated\Models\RuleWriteResponse;
use TeamBattles\Sdk\Generated\Models\UpdateGameRulesRequestBody;
...
class UpdateRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/leagues/{identifier}/rules/update');
     ...
     * @throws Exception
    */
    public function post(UpdateGameRulesRequestBody $body, ?UpdateRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [RuleWriteResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toPostRequestInformation(UpdateGameRulesRequestBody $body, ?UpdateRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
