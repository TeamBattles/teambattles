...
use TeamBattles\Sdk\Generated\Models\ApiUserConnection;
...
{
    /**
     * @var array<ApiUserConnection>|null $connections The connections property
    */
    ...
    */
     ...
     * @return array<ApiUserConnection>|null
    */
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'connections' => fn(ParseNode $n) => $o->setConnections($n->getCollectionOfObjectValues([ApiUserConnection::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<ApiUserConnection>|null $value Value to set for the connections property.
    */
