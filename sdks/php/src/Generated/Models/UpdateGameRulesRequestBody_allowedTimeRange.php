...
class UpdateGameRulesRequestBody_allowedTimeRange implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UpdateGameRulesRequestBody_allowedTimeRange and sets the default values.
    */
     ...
     * @return UpdateGameRulesRequestBody_allowedTimeRange
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UpdateGameRulesRequestBody_allowedTimeRange {
        return new UpdateGameRulesRequestBody_allowedTimeRange();
    }
