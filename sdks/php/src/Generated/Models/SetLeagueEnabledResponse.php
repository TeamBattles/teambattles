...
class SetLeagueEnabledResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return SetLeagueEnabledResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SetLeagueEnabledResponse {
