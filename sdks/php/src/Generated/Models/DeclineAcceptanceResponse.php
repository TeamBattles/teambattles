...
class DeclineAcceptanceResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return DeclineAcceptanceResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeclineAcceptanceResponse {
        return new DeclineAcceptanceResponse();
    }
