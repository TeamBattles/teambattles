...
class ApiBatchStreamStatusBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<string>|null $userIds User IDs to look up (1-50).
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ApiBatchStreamStatusBody {
