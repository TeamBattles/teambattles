...
class ForfeitMatchResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return ForfeitMatchResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ForfeitMatchResponse {
