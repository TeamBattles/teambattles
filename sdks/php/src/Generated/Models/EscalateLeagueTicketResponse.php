...
class EscalateLeagueTicketResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return EscalateLeagueTicketResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EscalateLeagueTicketResponse {
