...
class RemoveLeagueGameResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return RemoveLeagueGameResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RemoveLeagueGameResponse {
        return new RemoveLeagueGameResponse();
    }
