...
class SetTeamMemberRoleResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return SetTeamMemberRoleResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SetTeamMemberRoleResponse {
        return new SetTeamMemberRoleResponse();
    }
