...
class AddLeagueMemberResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return AddLeagueMemberResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AddLeagueMemberResponse {
