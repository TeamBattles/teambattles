...
class ReplyLeagueTicketResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return ReplyLeagueTicketResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ReplyLeagueTicketResponse {
        return new ReplyLeagueTicketResponse();
    }
