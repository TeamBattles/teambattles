...
class CreateLeagueTicketResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return CreateLeagueTicketResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreateLeagueTicketResponse {
        return new CreateLeagueTicketResponse();
    }
