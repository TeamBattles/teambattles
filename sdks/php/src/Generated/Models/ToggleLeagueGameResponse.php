...
class ToggleLeagueGameResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return ToggleLeagueGameResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ToggleLeagueGameResponse {
