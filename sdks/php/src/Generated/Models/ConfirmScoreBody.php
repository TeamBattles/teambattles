...
class ConfirmScoreBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var int|null $mapIndex Zero-based map index to confirm. Must be a non-negative integer.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ConfirmScoreBody {
