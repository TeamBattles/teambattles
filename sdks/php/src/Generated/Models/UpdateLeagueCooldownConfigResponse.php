...
class UpdateLeagueCooldownConfigResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return UpdateLeagueCooldownConfigResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UpdateLeagueCooldownConfigResponse {
        return new UpdateLeagueCooldownConfigResponse();
    }
