...
class ActivateLeagueSeasonResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return ActivateLeagueSeasonResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ActivateLeagueSeasonResponse {
        return new ActivateLeagueSeasonResponse();
    }
