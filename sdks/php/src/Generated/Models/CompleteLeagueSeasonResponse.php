...
class CompleteLeagueSeasonResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return CompleteLeagueSeasonResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CompleteLeagueSeasonResponse {
        return new CompleteLeagueSeasonResponse();
    }
