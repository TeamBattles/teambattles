...
class UpdateLeagueMemberRoleResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return UpdateLeagueMemberRoleResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UpdateLeagueMemberRoleResponse {
        return new UpdateLeagueMemberRoleResponse();
    }
