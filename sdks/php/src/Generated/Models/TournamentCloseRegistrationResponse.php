...
*/
class TournamentCloseRegistrationResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return TournamentCloseRegistrationResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TournamentCloseRegistrationResponse {
        return new TournamentCloseRegistrationResponse();
    }
