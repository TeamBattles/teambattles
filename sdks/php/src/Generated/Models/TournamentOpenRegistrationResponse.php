...
*/
class TournamentOpenRegistrationResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return TournamentOpenRegistrationResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TournamentOpenRegistrationResponse {
        return new TournamentOpenRegistrationResponse();
    }
