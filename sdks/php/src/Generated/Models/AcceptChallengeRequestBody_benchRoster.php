...
class AcceptChallengeRequestBody_benchRoster implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AcceptChallengeRequestBody_benchRoster and sets the default values.
    */
     ...
     * @return AcceptChallengeRequestBody_benchRoster
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AcceptChallengeRequestBody_benchRoster {
        return new AcceptChallengeRequestBody_benchRoster();
    }
