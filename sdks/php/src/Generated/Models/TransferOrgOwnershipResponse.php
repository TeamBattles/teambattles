...
class TransferOrgOwnershipResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return TransferOrgOwnershipResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TransferOrgOwnershipResponse {
        return new TransferOrgOwnershipResponse();
    }
