...
class ApproveAcceptanceResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return ApproveAcceptanceResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ApproveAcceptanceResponse {
