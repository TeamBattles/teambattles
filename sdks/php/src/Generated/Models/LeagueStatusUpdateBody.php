...
class LeagueStatusUpdateBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $status Target status. Allowed league transitions: READY -> IN_PROGRESS|CANCELLED, ACCEPTED -> CANCELLED. COMPLETED is not accepted directly; matches complete automatically once scores are confirmed.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): LeagueStatusUpdateBody {
