...
class DeclineAcceptanceRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $responseMessage Optional message sent to the declined team.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeclineAcceptanceRequestBody {
