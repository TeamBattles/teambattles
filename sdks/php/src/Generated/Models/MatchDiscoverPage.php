...
class MatchDiscoverPage implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MatchDiscoverPage {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'data' => fn(ParseNode $n) => $o->setData($n->getCollectionOfObjectValues([ApiMatchDetail::class, 'createFromDiscriminatorValue'])),
            'hasMore' => fn(ParseNode $n) => $o->setHasMore($n->getBooleanValue()),
            'nextCursor' => fn(ParseNode $n) => $o->setNextCursor($n->getObjectValue([MatchDiscoverPage_nextCursor::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @return MatchDiscoverPage_nextCursor|null
    */
    public function getNextCursor(): ?MatchDiscoverPage_nextCursor {
    ...
    */
     ...
     * @param array<ApiMatchDetail>|null $value Value to set for the data property.
    */
    ...
    */
     ...
     * @param MatchDiscoverPage_nextCursor|null $value Value to set for the nextCursor property.
    */
    public function setNextCursor(?MatchDiscoverPage_nextCursor $value): void {
