...
class RemoveLeagueMemberResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return RemoveLeagueMemberResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RemoveLeagueMemberResponse {
