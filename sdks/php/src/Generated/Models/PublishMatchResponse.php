...
class PublishMatchResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return PublishMatchResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PublishMatchResponse {
