...
class AcceptMatchRequestBody_benchRoster implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AcceptMatchRequestBody_benchRoster and sets the default values.
    */
     ...
     * @return AcceptMatchRequestBody_benchRoster
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AcceptMatchRequestBody_benchRoster {
        return new AcceptMatchRequestBody_benchRoster();
    }
