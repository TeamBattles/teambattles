...
class UpdateLeagueTicketResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return UpdateLeagueTicketResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UpdateLeagueTicketResponse {
        return new UpdateLeagueTicketResponse();
    }
