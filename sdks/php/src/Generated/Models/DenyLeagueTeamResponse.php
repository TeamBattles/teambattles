...
class DenyLeagueTeamResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return DenyLeagueTeamResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DenyLeagueTeamResponse {
