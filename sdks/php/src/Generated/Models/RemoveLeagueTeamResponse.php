...
class RemoveLeagueTeamResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return RemoveLeagueTeamResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RemoveLeagueTeamResponse {
