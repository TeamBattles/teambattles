...
{
    /**
     * @var string|null $id The created organization ID.
    */
    private ?string $id = null;
    
    /**
     * @var string|null $slug The created organization slug.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreateOrgResponse {
    ...
    */
    ...
    /**
     * Gets the id property value. The created organization ID.
     * @return string|null
    */
    ...
    /**
     * Gets the slug property value. The created organization slug.
     * @return string|null
    */
    ...
    */
    ...
    /**
     * Sets the id property value. The created organization ID.
    ...
    */
    ...
    /**
     * Sets the slug property value. The created organization slug.
