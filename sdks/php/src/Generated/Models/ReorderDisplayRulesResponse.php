...
class ReorderDisplayRulesResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return ReorderDisplayRulesResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ReorderDisplayRulesResponse {
        return new ReorderDisplayRulesResponse();
    }
