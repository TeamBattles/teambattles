...
class GameMultiMatchScoreItem_playerStats implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GameMultiMatchScoreItem_playerStats {
        return new GameMultiMatchScoreItem_playerStats();
    }
