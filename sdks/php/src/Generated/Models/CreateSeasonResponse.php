...
class CreateSeasonResponse implements Parsable 
{
    /**
     * @var string|null $seasonId The seasonId property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreateSeasonResponse {
    ...
    */
    ...
    /**
     * Gets the seasonId property value. The seasonId property
     * @return string|null
    */
    ...
    */
    ...
    /**
     * Sets the seasonId property value. The seasonId property
