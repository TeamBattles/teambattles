...
class ApproveLeagueTeamResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return ApproveLeagueTeamResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ApproveLeagueTeamResponse {
        return new ApproveLeagueTeamResponse();
    }
