...
class TransferLeagueOwnershipResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return TransferLeagueOwnershipResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TransferLeagueOwnershipResponse {
        return new TransferLeagueOwnershipResponse();
    }
