...
class GameRankListResponse implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<ApiGameRank>|null $gameRanks The gameRanks property
    */
    private ?array $gameRanks = null;
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GameRankListResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'gameRanks' => fn(ParseNode $n) => $o->setGameRanks($n->getCollectionOfObjectValues([ApiGameRank::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<ApiGameRank>|null $value Value to set for the gameRanks property.
    */
    public function setGameRanks(?array $value): void {
