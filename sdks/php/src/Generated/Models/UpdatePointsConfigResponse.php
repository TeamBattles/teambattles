...
class UpdatePointsConfigResponse implements Parsable 
{
    /**
     * @var string|null $configId The configId property
    */
    ...
    */
     ...
     * @return UpdatePointsConfigResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UpdatePointsConfigResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'configId' => fn(ParseNode $n) => $o->setConfigId($n->getStringValue()),
    ...
    */
     ...
     * @param string|null $value Value to set for the configId property.
    */
    public function setConfigId(?string $value): void {
        $this->configId = $value;
    }
