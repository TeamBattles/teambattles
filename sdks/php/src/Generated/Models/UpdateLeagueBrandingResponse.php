...
class UpdateLeagueBrandingResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return UpdateLeagueBrandingResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UpdateLeagueBrandingResponse {
        return new UpdateLeagueBrandingResponse();
    }
