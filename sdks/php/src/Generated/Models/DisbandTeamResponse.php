...
class DisbandTeamResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return DisbandTeamResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DisbandTeamResponse {
