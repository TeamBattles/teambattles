...
class DeleteLeagueSeasonResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return DeleteLeagueSeasonResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeleteLeagueSeasonResponse {
        return new DeleteLeagueSeasonResponse();
    }
