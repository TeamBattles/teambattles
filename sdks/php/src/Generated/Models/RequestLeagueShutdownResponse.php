...
class RequestLeagueShutdownResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return RequestLeagueShutdownResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RequestLeagueShutdownResponse {
        return new RequestLeagueShutdownResponse();
    }
