...
class LeagueDisplayRulesRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $gameId Game ID to list display rules for.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): LeagueDisplayRulesRequestBody {
        return new LeagueDisplayRulesRequestBody();
    }
