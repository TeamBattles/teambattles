...
class ApplyRuleTemplateRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $gameId Game ID to apply the template to.
    */
    private ?string $gameId = null;
    
    /**
     * @var string|null $templateId League rule template ID.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ApplyRuleTemplateRequestBody {
