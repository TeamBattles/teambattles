...
class SetOrgMemberRoleResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return SetOrgMemberRoleResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SetOrgMemberRoleResponse {
        return new SetOrgMemberRoleResponse();
    }
