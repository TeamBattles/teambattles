...
namespace TeamBattles\Sdk\Generated\Orgs\Item\Matches;
...
use TeamBattles\Sdk\Generated\Models\MatchesRequestBody;
...
class MatchesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/orgs/{identifier}/matches');
     ...
     * @param MatchesRequestBody $body Filters and cursor pagination for listing matches.
     ...
     * @throws Exception
    */
    public function post(MatchesRequestBody $body, ?MatchesRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(MatchesRequestBody $body, ?MatchesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
