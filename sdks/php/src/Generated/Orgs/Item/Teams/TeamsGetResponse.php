...
use TeamBattles\Sdk\Generated\Models\ApiTeamSummary;
...
class TeamsGetResponse implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<ApiTeamSummary>|null $teams The teams property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'teams' => fn(ParseNode $n) => $o->setTeams($n->getCollectionOfObjectValues([ApiTeamSummary::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<ApiTeamSummary>|null
    */
    ...
    */
     ...
     * @param array<ApiTeamSummary>|null $value Value to set for the teams property.
    */
