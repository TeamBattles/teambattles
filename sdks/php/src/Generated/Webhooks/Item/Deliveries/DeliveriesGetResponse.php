...
class DeliveriesGetResponse implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeliveriesGetResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'page' => fn(ParseNode $n) => $o->setPage($n->getCollectionOfObjectValues([WebhookDelivery::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
     ...
     * @return array<WebhookDelivery>|null
    */
    ...
    */
     ...
     * @param array<WebhookDelivery>|null $value Value to set for the page property.
    */
