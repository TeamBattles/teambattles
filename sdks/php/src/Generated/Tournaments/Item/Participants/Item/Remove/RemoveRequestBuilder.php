...
namespace TeamBattles\Sdk\Generated\Tournaments\Item\Participants\Item\Remove;
...
use TeamBattles\Sdk\Generated\Models\TournamentRemoveParticipantBody;
...
class RemoveRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/tournaments/{identifier}/participants/{participantId}/remove');
     ...
     * @param TournamentRemoveParticipantBody $body Participant removal payload.
     ...
     * @throws Exception
    */
    public function post(TournamentRemoveParticipantBody $body, ?RemoveRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(TournamentRemoveParticipantBody $body, ?RemoveRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
