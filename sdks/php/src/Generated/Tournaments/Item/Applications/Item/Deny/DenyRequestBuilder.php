...
namespace TeamBattles\Sdk\Generated\Tournaments\Item\Applications\Item\Deny;
...
use TeamBattles\Sdk\Generated\Models\TournamentDenyApplicationBody;
...
class DenyRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/tournaments/{identifier}/applications/{participantId}/deny');
     ...
     * @param TournamentDenyApplicationBody $body Application denial payload.
     ...
     * @throws Exception
    */
    public function post(TournamentDenyApplicationBody $body, ?DenyRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(TournamentDenyApplicationBody $body, ?DenyRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
