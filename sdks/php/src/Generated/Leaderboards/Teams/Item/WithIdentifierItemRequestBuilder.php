...
namespace TeamBattles\Sdk\Generated\Leaderboards\Teams\Item;

use Microsoft\Kiota\Abstractions\BaseRequestBuilder;
use Microsoft\Kiota\Abstractions\RequestAdapter;
use TeamBattles\Sdk\Generated\Leaderboards\Teams\Item\Rank\RankRequestBuilder;
...
class WithIdentifierItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/leaderboards/teams/{identifier}');
