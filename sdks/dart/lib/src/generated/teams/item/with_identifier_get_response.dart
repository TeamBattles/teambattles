...
import '../../models/api_team_profile.dart';
...
class WithIdentifierGetResponse implements Parsable {
    ...
    Map<String, void Function(ParseNode)> getFieldDeserializers() {
        ...
        deserializerMap['team'] = (node) => team = node.getObjectValue<ApiTeamProfile>(ApiTeamProfile.createFromDiscriminatorValue);
    ...
    void serialize(SerializationWriter writer) {
        writer.writeObjectValue<ApiTeamProfile>('team', team);
