...
class WithMapIndexItemRequestBuilder extends BaseRequestBuilder<WithMapIndexItemRequestBuilder> {
    ...
    WithMapIndexItemRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/game/matches/{matchId}/scores/{mapIndex}", pathParameters) ;
    /// Instantiates a new [WithMapIndexItemRequestBuilder] and sets the default values.
    ///  [rawUrl] The raw URL to use for the request builder.
    ///  [requestAdapter] The request adapter to use to execute the requests.
    WithMapIndexItemRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/game/matches/{matchId}/scores/{mapIndex}", {RequestInformation.rawUrlKey : rawUrl}) ;
