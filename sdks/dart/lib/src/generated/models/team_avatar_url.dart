...
import './team_avatar_url_member1.dart';
...
class TeamAvatarUrl implements Parsable {
    ...
    static TeamAvatarUrl createFromDiscriminatorValue(ParseNode parseNode) {
        ...
        if(parseNode.getStringValue() != null) {
            ...
            result.teamAvatarUrlMember1 = TeamAvatarUrlMember1();
        }
        return result;
    }
    ...
    Map<String, void Function(ParseNode)> getFieldDeserializers() {
        ...
        if(teamAvatarUrlMember1 != null){teamAvatarUrlMember1!.getFieldDeserializers().forEach((k,v) => deserializers.putIfAbsent(k, ()=>v));}
    ...
    void serialize(SerializationWriter writer) {
        if(string_ != null) {
            ...
            writer.writeObjectValue<TeamAvatarUrlMember1>(null, teamAvatarUrlMember1);
        }
    }
}
