...
class UpsertDisplayRuleResponse implements Parsable {
    ...
    static UpsertDisplayRuleResponse createFromDiscriminatorValue(ParseNode parseNode) {
    ...
    Map<String, void Function(ParseNode)> getFieldDeserializers() {
        ...
        deserializerMap['displayRuleId'] = (node) => displayRuleId = node.getStringValue();
    ...
    void serialize(SerializationWriter writer) {
        writer.writeStringValue('displayRuleId', displayRuleId);
