...
class AcceptMatchResponse implements Parsable {
    ...
    static AcceptMatchResponse createFromDiscriminatorValue(ParseNode parseNode) {
    ...
    Map<String, void Function(ParseNode)> getFieldDeserializers() {
        ...
        deserializerMap['acceptanceId'] = (node) => acceptanceId = node.getStringValue();
    ...
    void serialize(SerializationWriter writer) {
        writer.writeStringValue('acceptanceId', acceptanceId);
