...
class CreatePenaltyResponse implements Parsable {
    ...
    static CreatePenaltyResponse createFromDiscriminatorValue(ParseNode parseNode) {
    ...
    Map<String, void Function(ParseNode)> getFieldDeserializers() {
        ...
        deserializerMap['penaltyId'] = (node) => penaltyId = node.getStringValue();
    ...
    void serialize(SerializationWriter writer) {
        writer.writeStringValue('penaltyId', penaltyId);
