...
class OwnershipRequestBuilder extends BaseRequestBuilder<OwnershipRequestBuilder> {
    ...
    OwnershipRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/orgs/{identifier}/ownership", pathParameters) ;
    /// Instantiates a new [OwnershipRequestBuilder] and sets the default values.
    ///  [rawUrl] The raw URL to use for the request builder.
    ///  [requestAdapter] The request adapter to use to execute the requests.
    OwnershipRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/orgs/{identifier}/ownership", {RequestInformation.rawUrlKey : rawUrl}) ;
}
