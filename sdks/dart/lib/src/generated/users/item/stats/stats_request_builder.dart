...
class StatsRequestBuilder extends BaseRequestBuilder<StatsRequestBuilder> {
    ...
    StatsRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/users/{identifier}/stats", pathParameters) ;
    /// Instantiates a new [StatsRequestBuilder] and sets the default values.
    ///  [rawUrl] The raw URL to use for the request builder.
    ///  [requestAdapter] The request adapter to use to execute the requests.
    StatsRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/users/{identifier}/stats", {RequestInformation.rawUrlKey : rawUrl}) ;
