...
class MatchesPostResponse implements Parsable {
    ...
    Map<String, void Function(ParseNode)> getFieldDeserializers() {
        ...
        deserializerMap['page'] = (node) => page = node.getCollectionOfObjectValues<UserMatch>(UserMatch.createFromDiscriminatorValue);
    ...
    void serialize(SerializationWriter writer) {
        ...
        writer.writeCollectionOfObjectValues<UserMatch>('page', page);
    }
}
