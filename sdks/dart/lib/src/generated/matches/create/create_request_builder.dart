...
import '../../models/create_match_request_body.dart';
...
class CreateRequestBuilder extends BaseRequestBuilder<CreateRequestBuilder> {
    ...
    CreateRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/matches/create", pathParameters) ;
    /// Instantiates a new [CreateRequestBuilder] and sets the default values.
