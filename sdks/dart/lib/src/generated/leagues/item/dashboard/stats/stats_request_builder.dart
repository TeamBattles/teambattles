...
import '../../../../models/league_dashboard_stats_response.dart';
...
class StatsRequestBuilder extends BaseRequestBuilder<StatsRequestBuilder> {
    ...
    StatsRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/leagues/{identifier}/dashboard/stats", pathParameters) ;
    /// Instantiates a new [StatsRequestBuilder] and sets the default values.
