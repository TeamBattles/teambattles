...
class PlayerStatsRequestBuilder extends BaseRequestBuilder<PlayerStatsRequestBuilder> {
    ...
    PlayerStatsRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/leagues/{identifier}/matches/{matchId}/player-stats", pathParameters) ;
    /// Instantiates a new [PlayerStatsRequestBuilder] and sets the default values.
