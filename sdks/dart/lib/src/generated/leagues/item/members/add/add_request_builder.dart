...
import '../../../../models/add_league_member_request_body.dart';
import '../../../../models/add_league_member_response.dart';
...
class AddRequestBuilder extends BaseRequestBuilder<AddRequestBuilder> {
    ...
    AddRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/leagues/{identifier}/members/add", pathParameters) ;
    /// Instantiates a new [AddRequestBuilder] and sets the default values.
