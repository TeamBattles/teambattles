...
import '../../../../models/upsert_display_rule_request_body.dart';
import '../../../../models/upsert_display_rule_response.dart';

/// auto generated
/// Builds and executes requests for operations under \leagues\{identifier}\display-rules\upsert
class UpsertRequestBuilder extends BaseRequestBuilder<UpsertRequestBuilder> {
    /// Clones the requestbuilder.
    @override
    UpsertRequestBuilder clone() {
    ...
    UpsertRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/leagues/{identifier}/display-rules/upsert", pathParameters) ;
    /// Instantiates a new [UpsertRequestBuilder] and sets the default values.
