...
// @ts-ignore
import { createErrorEscapedFromDiscriminatorValue, createTwitchGlobalBadgesFromDiscriminatorValue, type ErrorEscaped, type TwitchGlobalBadges } from '../../../models/index.js';
// @ts-ignore
 ...
 */
export const GlobalRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
