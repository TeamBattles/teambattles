...
// @ts-ignore
import { createApproveAcceptanceResponseFromDiscriminatorValue, createErrorEscapedFromDiscriminatorValue, serializeApproveAcceptanceRequestBody, serializeApproveAcceptanceResponse, type ApproveAcceptanceRequestBody, type ApproveAcceptanceResponse, type ErrorEscaped } from '../../../../../models/index.js';
// @ts-ignore
...
export interface ApproveRequestBuilder extends BaseRequestBuilder<ApproveRequestBuilder> {
     ...
     * @returns {Promise<ApproveAcceptanceResponse>}
     ...
     */
     post(body: ApproveAcceptanceRequestBody, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ApproveAcceptanceResponse | undefined>;
    /**
     * Approves a pending match acceptance as the personal API key owner. The owner must captain the creator team, and the acceptance must still be pending. Requires matches.user_matches:read-write and API writes access. Supports an optional `Idempotency-Key` header for safe retries.
     * @param body Approves a pending match acceptance as the API key owner.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: ApproveAcceptanceRequestBody, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const ApproveRequestBuilderUriTemplate = "{+baseurl}/matches/{matchId}/acceptances/{acceptanceId}/approve";
/**
...
export const ApproveRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createApproveAcceptanceResponseFromDiscriminatorValue,
        requestBodyContentType: "application/json",
        requestBodySerializer: serializeApproveAcceptanceRequestBody,
