...
// @ts-ignore
import { createErrorEscapedFromDiscriminatorValue, createRemoveTeamMemberResponseFromDiscriminatorValue, type ErrorEscaped, type RemoveTeamMemberResponse } from '../../../../models/index.js';
// @ts-ignore
...
export interface WithUserItemRequestBuilder extends BaseRequestBuilder<WithUserItemRequestBuilder> {
     ...
     */
     delete(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<RemoveTeamMemberResponse | undefined>;
    /**
     * Removes a member from a team, or removes yourself to leave it. To remove another member, the caller (key owner) must be the team captain or co-captain; any member may remove themselves. The team captain cannot be removed this way - disband the team or transfer captaincy first. Requires teams.roster:read-write.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithUserItemRequestBuilderUriTemplate = "{+baseurl}/teams/{identifier}/members/{userId}";
/**
...
export const WithUserItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    delete: {
        ...
        responseBodyFactory:  createRemoveTeamMemberResponseFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
