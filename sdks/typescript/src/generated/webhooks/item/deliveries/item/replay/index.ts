...
// @ts-ignore
import { createErrorEscapedFromDiscriminatorValue, createWebhookReplayResultFromDiscriminatorValue, type ErrorEscaped, type WebhookReplayResult } from '../../../../../models/index.js';
// @ts-ignore
 ...
 */
export const ReplayRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
