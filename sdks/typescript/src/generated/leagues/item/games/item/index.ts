...
// @ts-ignore
import { createErrorEscapedFromDiscriminatorValue, createRemoveLeagueGameResponseFromDiscriminatorValue, type ErrorEscaped, type RemoveLeagueGameResponse } from '../../../../models/index.js';
// @ts-ignore
import { ToggleRequestBuilderRequestsMetadata, type ToggleRequestBuilder } from './toggle/index.js';
// @ts-ignore
 ...
 */
export const WithLeagueGameItemRequestBuilderNavigationMetadata: Record<Exclude<keyof WithLeagueGameItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    toggle: {
 ...
 */
export const WithLeagueGameItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    delete: {
