 ...
 */
export const WithMemberItemRequestBuilderNavigationMetadata: Record<Exclude<keyof WithMemberItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    remove: {
