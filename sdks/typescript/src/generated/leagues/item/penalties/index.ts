 ...
 */
export const PenaltiesRequestBuilderNavigationMetadata: Record<Exclude<keyof PenaltiesRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    create: {
