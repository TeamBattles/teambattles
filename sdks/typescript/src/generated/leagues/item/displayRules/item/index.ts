...
// @ts-ignore
import { createErrorEscapedFromDiscriminatorValue, createRemoveDisplayRuleResponseFromDiscriminatorValue, type ErrorEscaped, type RemoveDisplayRuleResponse } from '../../../../models/index.js';
// @ts-ignore
 ...
 */
export const WithDisplayRuleItemRequestBuilderUriTemplate = "{+baseurl}/leagues/{identifier}/display-rules/{displayRuleId}";
/**
 * Metadata for all the requests in the request builder.
 */
export const WithDisplayRuleItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    delete: {
        uriTemplate: WithDisplayRuleItemRequestBuilderUriTemplate,
        ...
        responseBodyFactory:  createRemoveDisplayRuleResponseFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
