...
| -------------------------- | ---------------- | ---------------------- |
| Call of Duty: Modern Warfare 4 | 6 (4 competitive) | Available          |
| Call of Duty: Black Ops 7  | 6 (4 competitive) | Available              |
| Call of Duty: Black Ops 6  | 6 (4 competitive) | Available              |
| Valorant                   | 5       | Available              |
| League of Legends          | 5       | Available              |
| Counter-Strike 2           | 5       | Available              |
...
<Note>
	...
	or accept challenges. **Counter-Strike 2** supports 5v5 match creation, challenges, leagues, and
	the [Strategy editor](/strategy/managing-strategies); rank tracking is not wired up yet. **Call of
	Duty: Black Ops 6** supports match creation, challenges, leagues, and the Strategy editor too; it
