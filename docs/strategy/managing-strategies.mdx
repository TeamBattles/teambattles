...
with player tokens already placed at the two spawns rather than on an empty board. League of Legends
Arena maps and custom maps start empty; drag tokens in from the **Tokens** panel as usual.
...
- **Counter-Strike 2** - 2 player variants, 6 pieces of equipment, and 5 general markers: 13 in total.
...
overlays at all - League of Legends, for instance - have no Overlays button.
