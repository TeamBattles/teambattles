...
helmet mark, the TeamBattles wordmark, your board's name and the frame you picked - so a board
posted into a channel says what it is without its filename. The frame is skinned from your own
**Appearance** settings, so a board exported on the Light theme or the cyan accent matches the app
you are looking at.
